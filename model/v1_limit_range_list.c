...
v1_limit_range_list_t *v1_limit_range_list_create(
	...
	v1_limit_range_list_local_var->apiVersion = apiVersion;
...
void v1_limit_range_list_free(v1_limit_range_list_t *v1_limit_range_list) {
    ...
    free(v1_limit_range_list->apiVersion);
...
cJSON *v1_limit_range_list_convertToJSON(v1_limit_range_list_t *v1_limit_range_list) {
	...
	// v1_limit_range_list->apiVersion
    if(v1_limit_range_list->apiVersion) { 
    if(cJSON_AddStringToObject(item, "apiVersion", v1_limit_range_list->apiVersion) == NULL) {
    goto fail; //String
    }
     } 
...
v1_limit_range_list_t *v1_limit_range_list_parseFromJSON(cJSON *v1_limit_range_listJSON){
    ...
    // v1_limit_range_list->apiVersion
    cJSON *apiVersion = cJSON_GetObjectItemCaseSensitive(v1_limit_range_listJSON, "apiVersion");
    if (apiVersion) { 
