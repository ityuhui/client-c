...
v1_network_policy_spec_t *v1_network_policy_spec_create(
	...
	v1_network_policy_spec_local_var->podSelector = podSelector;
	v1_network_policy_spec_local_var->policyTypes = policyTypes;
...
void v1_network_policy_spec_free(v1_network_policy_spec_t *v1_network_policy_spec) {
    ...
    v1_label_selector_free(v1_network_policy_spec->podSelector);
	list_ForEach(listEntry, v1_network_policy_spec->policyTypes) {
		free(listEntry->data);
	}
	list_free(v1_network_policy_spec->policyTypes);
...
cJSON *v1_network_policy_spec_convertToJSON(v1_network_policy_spec_t *v1_network_policy_spec) {
	...
	// v1_network_policy_spec->podSelector
    if (!v1_network_policy_spec->podSelector) {
        goto fail;
    }
    
    cJSON *podSelector_local_JSON = v1_label_selector_convertToJSON(v1_network_policy_spec->podSelector);
	...
	// v1_network_policy_spec->policyTypes
    if(v1_network_policy_spec->policyTypes) { 
    ...
    list_ForEach(policy_typesListEntry, v1_network_policy_spec->policyTypes) {
...
v1_network_policy_spec_t *v1_network_policy_spec_parseFromJSON(cJSON *v1_network_policy_specJSON){
    ...
    // v1_network_policy_spec->podSelector
    cJSON *podSelector = cJSON_GetObjectItemCaseSensitive(v1_network_policy_specJSON, "podSelector");
    if (!podSelector) {
        goto end;
    }
    ...
    // v1_network_policy_spec->policyTypes
    cJSON *policyTypes = cJSON_GetObjectItemCaseSensitive(v1_network_policy_specJSON, "policyTypes");
