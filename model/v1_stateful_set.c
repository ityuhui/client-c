...
v1_stateful_set_t *v1_stateful_set_create(
	...
	v1_stateful_set_local_var->apiVersion = apiVersion;
...
void v1_stateful_set_free(v1_stateful_set_t *v1_stateful_set) {
    ...
    free(v1_stateful_set->apiVersion);
...
cJSON *v1_stateful_set_convertToJSON(v1_stateful_set_t *v1_stateful_set) {
	...
	// v1_stateful_set->apiVersion
    if(v1_stateful_set->apiVersion) { 
    if(cJSON_AddStringToObject(item, "apiVersion", v1_stateful_set->apiVersion) == NULL) {
    goto fail; //String
    }
     } 
...
v1_stateful_set_t *v1_stateful_set_parseFromJSON(cJSON *v1_stateful_setJSON){
    ...
    // v1_stateful_set->apiVersion
    cJSON *apiVersion = cJSON_GetObjectItemCaseSensitive(v1_stateful_setJSON, "apiVersion");
    if (apiVersion) { 
