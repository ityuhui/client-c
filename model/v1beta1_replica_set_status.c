...
v1beta1_replica_set_status_t *v1beta1_replica_set_status_create(
	...
	v1beta1_replica_set_status_local_var->availableReplicas = availableReplicas;
	v1beta1_replica_set_status_local_var->conditions = conditions;
	v1beta1_replica_set_status_local_var->fullyLabeledReplicas = fullyLabeledReplicas;
	v1beta1_replica_set_status_local_var->observedGeneration = observedGeneration;
	v1beta1_replica_set_status_local_var->readyReplicas = readyReplicas;
...
cJSON *v1beta1_replica_set_status_convertToJSON(v1beta1_replica_set_status_t *v1beta1_replica_set_status) {
	...
	// v1beta1_replica_set_status->availableReplicas
    if(v1beta1_replica_set_status->availableReplicas) { 
    if(cJSON_AddNumberToObject(item, "availableReplicas", v1beta1_replica_set_status->availableReplicas) == NULL) {
    goto fail; //Numeric
    }
     } 
	...
	// v1beta1_replica_set_status->fullyLabeledReplicas
    if(v1beta1_replica_set_status->fullyLabeledReplicas) { 
    if(cJSON_AddNumberToObject(item, "fullyLabeledReplicas", v1beta1_replica_set_status->fullyLabeledReplicas) == NULL) {
    goto fail; //Numeric
    }
     } 


	// v1beta1_replica_set_status->observedGeneration
    if(v1beta1_replica_set_status->observedGeneration) { 
    if(cJSON_AddNumberToObject(item, "observedGeneration", v1beta1_replica_set_status->observedGeneration) == NULL) {
    goto fail; //Numeric
    }
     } 


	// v1beta1_replica_set_status->readyReplicas
    if(v1beta1_replica_set_status->readyReplicas) { 
    if(cJSON_AddNumberToObject(item, "readyReplicas", v1beta1_replica_set_status->readyReplicas) == NULL) {
    goto fail; //Numeric
    }
     } 
...
v1beta1_replica_set_status_t *v1beta1_replica_set_status_parseFromJSON(cJSON *v1beta1_replica_set_statusJSON){
    ...
    // v1beta1_replica_set_status->availableReplicas
    cJSON *availableReplicas = cJSON_GetObjectItemCaseSensitive(v1beta1_replica_set_statusJSON, "availableReplicas");
    ...
    // v1beta1_replica_set_status->fullyLabeledReplicas
    cJSON *fullyLabeledReplicas = cJSON_GetObjectItemCaseSensitive(v1beta1_replica_set_statusJSON, "fullyLabeledReplicas");
    ...
    // v1beta1_replica_set_status->observedGeneration
    cJSON *observedGeneration = cJSON_GetObjectItemCaseSensitive(v1beta1_replica_set_statusJSON, "observedGeneration");
    ...
    // v1beta1_replica_set_status->readyReplicas
    cJSON *readyReplicas = cJSON_GetObjectItemCaseSensitive(v1beta1_replica_set_statusJSON, "readyReplicas");
    if (readyReplicas) { 
