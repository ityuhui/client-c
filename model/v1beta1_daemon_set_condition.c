...
v1beta1_daemon_set_condition_t *v1beta1_daemon_set_condition_create(
	...
	v1beta1_daemon_set_condition_local_var->lastTransitionTime = lastTransitionTime;
...
void v1beta1_daemon_set_condition_free(v1beta1_daemon_set_condition_t *v1beta1_daemon_set_condition) {
    ...
    free(v1beta1_daemon_set_condition->lastTransitionTime);
...
cJSON *v1beta1_daemon_set_condition_convertToJSON(v1beta1_daemon_set_condition_t *v1beta1_daemon_set_condition) {
	...
	// v1beta1_daemon_set_condition->lastTransitionTime
    if(v1beta1_daemon_set_condition->lastTransitionTime) { 
    if(cJSON_AddStringToObject(item, "lastTransitionTime", v1beta1_daemon_set_condition->lastTransitionTime) == NULL) {
    goto fail; //Date-Time
    }
     } 
...
v1beta1_daemon_set_condition_t *v1beta1_daemon_set_condition_parseFromJSON(cJSON *v1beta1_daemon_set_conditionJSON){
    ...
    // v1beta1_daemon_set_condition->lastTransitionTime
    cJSON *lastTransitionTime = cJSON_GetObjectItemCaseSensitive(v1beta1_daemon_set_conditionJSON, "lastTransitionTime");
