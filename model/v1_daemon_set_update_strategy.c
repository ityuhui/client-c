...
v1_daemon_set_update_strategy_t *v1_daemon_set_update_strategy_create(
	...
	v1_daemon_set_update_strategy_local_var->rollingUpdate = rollingUpdate;
...
void v1_daemon_set_update_strategy_free(v1_daemon_set_update_strategy_t *v1_daemon_set_update_strategy) {
    ...
    v1_rolling_update_daemon_set_free(v1_daemon_set_update_strategy->rollingUpdate);
...
cJSON *v1_daemon_set_update_strategy_convertToJSON(v1_daemon_set_update_strategy_t *v1_daemon_set_update_strategy) {
	...
	// v1_daemon_set_update_strategy->rollingUpdate
    if(v1_daemon_set_update_strategy->rollingUpdate) { 
    cJSON *rollingUpdate_local_JSON = v1_rolling_update_daemon_set_convertToJSON(v1_daemon_set_update_strategy->rollingUpdate);
...
v1_daemon_set_update_strategy_t *v1_daemon_set_update_strategy_parseFromJSON(cJSON *v1_daemon_set_update_strategyJSON){
    ...
    // v1_daemon_set_update_strategy->rollingUpdate
    cJSON *rollingUpdate = cJSON_GetObjectItemCaseSensitive(v1_daemon_set_update_strategyJSON, "rollingUpdate");
    v1_rolling_update_daemon_set_t *rollingUpdate_local_nonprim = NULL;
    if (rollingUpdate) { 
    rollingUpdate_local_nonprim = v1_rolling_update_daemon_set_parseFromJSON(rollingUpdate); //nonprimitive
    }
