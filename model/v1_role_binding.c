...
v1_role_binding_t *v1_role_binding_create(
	...
	v1_role_binding_local_var->apiVersion = apiVersion;
	v1_role_binding_local_var->kind = kind;
	v1_role_binding_local_var->metadata = metadata;
	v1_role_binding_local_var->roleRef = roleRef;
...
cJSON *v1_role_binding_convertToJSON(v1_role_binding_t *v1_role_binding) {
	...
	// v1_role_binding->apiVersion
    if(v1_role_binding->apiVersion) { 
    if(cJSON_AddStringToObject(item, "apiVersion", v1_role_binding->apiVersion) == NULL) {
    goto fail; //String
    }
     } 
	...
	// v1_role_binding->roleRef
    if (!v1_role_binding->roleRef) {
        goto fail;
    }
    
    cJSON *roleRef_local_JSON = v1_role_ref_convertToJSON(v1_role_binding->roleRef);
...
v1_role_binding_t *v1_role_binding_parseFromJSON(cJSON *v1_role_bindingJSON){
    ...
    // v1_role_binding->apiVersion
    cJSON *apiVersion = cJSON_GetObjectItemCaseSensitive(v1_role_bindingJSON, "apiVersion");
    if (apiVersion) { 
    ...
    // v1_role_binding->roleRef
    cJSON *roleRef = cJSON_GetObjectItemCaseSensitive(v1_role_bindingJSON, "roleRef");
    if (!roleRef) {
        goto end;
    }
