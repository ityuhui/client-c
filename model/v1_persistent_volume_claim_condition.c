...
v1_persistent_volume_claim_condition_t *v1_persistent_volume_claim_condition_create(
	...
	v1_persistent_volume_claim_condition_local_var->lastProbeTime = lastProbeTime;
	v1_persistent_volume_claim_condition_local_var->lastTransitionTime = lastTransitionTime;
...
void v1_persistent_volume_claim_condition_free(v1_persistent_volume_claim_condition_t *v1_persistent_volume_claim_condition) {
    ...
    free(v1_persistent_volume_claim_condition->lastProbeTime);
    free(v1_persistent_volume_claim_condition->lastTransitionTime);
...
cJSON *v1_persistent_volume_claim_condition_convertToJSON(v1_persistent_volume_claim_condition_t *v1_persistent_volume_claim_condition) {
	...
	// v1_persistent_volume_claim_condition->lastProbeTime
    if(v1_persistent_volume_claim_condition->lastProbeTime) { 
    if(cJSON_AddStringToObject(item, "lastProbeTime", v1_persistent_volume_claim_condition->lastProbeTime) == NULL) {
    goto fail; //Date-Time
    }
     } 


	// v1_persistent_volume_claim_condition->lastTransitionTime
    if(v1_persistent_volume_claim_condition->lastTransitionTime) { 
    if(cJSON_AddStringToObject(item, "lastTransitionTime", v1_persistent_volume_claim_condition->lastTransitionTime) == NULL) {
    goto fail; //Date-Time
    }
     } 
...
v1_persistent_volume_claim_condition_t *v1_persistent_volume_claim_condition_parseFromJSON(cJSON *v1_persistent_volume_claim_conditionJSON){
    ...
    // v1_persistent_volume_claim_condition->lastProbeTime
    cJSON *lastProbeTime = cJSON_GetObjectItemCaseSensitive(v1_persistent_volume_claim_conditionJSON, "lastProbeTime");
    if (lastProbeTime) { 
    ...
    // v1_persistent_volume_claim_condition->lastTransitionTime
    cJSON *lastTransitionTime = cJSON_GetObjectItemCaseSensitive(v1_persistent_volume_claim_conditionJSON, "lastTransitionTime");
