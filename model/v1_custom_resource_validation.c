...
v1_custom_resource_validation_t *v1_custom_resource_validation_create(
	...
	v1_custom_resource_validation_local_var->openAPIV3Schema = openAPIV3Schema;
...
void v1_custom_resource_validation_free(v1_custom_resource_validation_t *v1_custom_resource_validation) {
    ...
    v1_json_schema_props_free(v1_custom_resource_validation->openAPIV3Schema);
...
cJSON *v1_custom_resource_validation_convertToJSON(v1_custom_resource_validation_t *v1_custom_resource_validation) {
	...
	// v1_custom_resource_validation->openAPIV3Schema
    if(v1_custom_resource_validation->openAPIV3Schema) { 
    cJSON *openAPIV3Schema_local_JSON = v1_json_schema_props_convertToJSON(v1_custom_resource_validation->openAPIV3Schema);
...
v1_custom_resource_validation_t *v1_custom_resource_validation_parseFromJSON(cJSON *v1_custom_resource_validationJSON){
    ...
    // v1_custom_resource_validation->openAPIV3Schema
    cJSON *openAPIV3Schema = cJSON_GetObjectItemCaseSensitive(v1_custom_resource_validationJSON, "openAPIV3Schema");
    v1_json_schema_props_t *openAPIV3Schema_local_nonprim = NULL;
    if (openAPIV3Schema) { 
    openAPIV3Schema_local_nonprim = v1_json_schema_props_parseFromJSON(openAPIV3Schema); //nonprimitive
    }
