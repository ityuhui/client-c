...
v1_api_service_t *v1_api_service_create(
	...
	v1_api_service_local_var->apiVersion = apiVersion;
...
void v1_api_service_free(v1_api_service_t *v1_api_service) {
    ...
    free(v1_api_service->apiVersion);
...
cJSON *v1_api_service_convertToJSON(v1_api_service_t *v1_api_service) {
	...
	// v1_api_service->apiVersion
    if(v1_api_service->apiVersion) { 
    if(cJSON_AddStringToObject(item, "apiVersion", v1_api_service->apiVersion) == NULL) {
    goto fail; //String
    }
     } 
...
v1_api_service_t *v1_api_service_parseFromJSON(cJSON *v1_api_serviceJSON){
    ...
    // v1_api_service->apiVersion
    cJSON *apiVersion = cJSON_GetObjectItemCaseSensitive(v1_api_serviceJSON, "apiVersion");
    if (apiVersion) { 
