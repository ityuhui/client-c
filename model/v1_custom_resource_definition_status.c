...
v1_custom_resource_definition_status_t *v1_custom_resource_definition_status_create(
	...
	v1_custom_resource_definition_status_local_var->acceptedNames = acceptedNames;
	v1_custom_resource_definition_status_local_var->conditions = conditions;
	v1_custom_resource_definition_status_local_var->storedVersions = storedVersions;
...
void v1_custom_resource_definition_status_free(v1_custom_resource_definition_status_t *v1_custom_resource_definition_status) {
    ...
    v1_custom_resource_definition_names_free(v1_custom_resource_definition_status->acceptedNames);
	...
	list_ForEach(listEntry, v1_custom_resource_definition_status->storedVersions) {
		free(listEntry->data);
	}
	list_free(v1_custom_resource_definition_status->storedVersions);
...
cJSON *v1_custom_resource_definition_status_convertToJSON(v1_custom_resource_definition_status_t *v1_custom_resource_definition_status) {
	...
	// v1_custom_resource_definition_status->acceptedNames
    if (!v1_custom_resource_definition_status->acceptedNames) {
        goto fail;
    }
    
    cJSON *acceptedNames_local_JSON = v1_custom_resource_definition_names_convertToJSON(v1_custom_resource_definition_status->acceptedNames);
	...
	// v1_custom_resource_definition_status->storedVersions
    if (!v1_custom_resource_definition_status->storedVersions) {
        goto fail;
    }
    ...
    list_ForEach(stored_versionsListEntry, v1_custom_resource_definition_status->storedVersions) {
...
v1_custom_resource_definition_status_t *v1_custom_resource_definition_status_parseFromJSON(cJSON *v1_custom_resource_definition_statusJSON){
    ...
    // v1_custom_resource_definition_status->acceptedNames
    cJSON *acceptedNames = cJSON_GetObjectItemCaseSensitive(v1_custom_resource_definition_statusJSON, "acceptedNames");
    if (!acceptedNames) {
        goto end;
    }

    v1_custom_resource_definition_names_t *acceptedNames_local_nonprim = NULL;
    
    acceptedNames_local_nonprim = v1_custom_resource_definition_names_parseFromJSON(acceptedNames); //nonprimitive
    ...
    // v1_custom_resource_definition_status->storedVersions
    cJSON *storedVersions = cJSON_GetObjectItemCaseSensitive(v1_custom_resource_definition_statusJSON, "storedVersions");
    if (!storedVersions) {
        goto end;
    }
