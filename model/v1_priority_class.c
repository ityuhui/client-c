...
v1_priority_class_t *v1_priority_class_create(
	...
	v1_priority_class_local_var->apiVersion = apiVersion;
	v1_priority_class_local_var->description = description;
	v1_priority_class_local_var->globalDefault = globalDefault;
	v1_priority_class_local_var->kind = kind;
	v1_priority_class_local_var->metadata = metadata;
	v1_priority_class_local_var->preemptionPolicy = preemptionPolicy;
...
cJSON *v1_priority_class_convertToJSON(v1_priority_class_t *v1_priority_class) {
	...
	// v1_priority_class->apiVersion
    if(v1_priority_class->apiVersion) { 
    if(cJSON_AddStringToObject(item, "apiVersion", v1_priority_class->apiVersion) == NULL) {
    goto fail; //String
    }
     } 
	...
	// v1_priority_class->globalDefault
    if(v1_priority_class->globalDefault) { 
    if(cJSON_AddBoolToObject(item, "globalDefault", v1_priority_class->globalDefault) == NULL) {
    goto fail; //Bool
    }
     } 
	...
	// v1_priority_class->preemptionPolicy
    if(v1_priority_class->preemptionPolicy) { 
    if(cJSON_AddStringToObject(item, "preemptionPolicy", v1_priority_class->preemptionPolicy) == NULL) {
    goto fail; //String
    }
     } 
...
v1_priority_class_t *v1_priority_class_parseFromJSON(cJSON *v1_priority_classJSON){
    ...
    // v1_priority_class->apiVersion
    cJSON *apiVersion = cJSON_GetObjectItemCaseSensitive(v1_priority_classJSON, "apiVersion");
    if (apiVersion) { 
    ...
    // v1_priority_class->globalDefault
    cJSON *globalDefault = cJSON_GetObjectItemCaseSensitive(v1_priority_classJSON, "globalDefault");
    if (globalDefault) { 
    ...
    // v1_priority_class->preemptionPolicy
    cJSON *preemptionPolicy = cJSON_GetObjectItemCaseSensitive(v1_priority_classJSON, "preemptionPolicy");
    if (preemptionPolicy) { 
