...
v1_resource_rule_t *v1_resource_rule_create(
	...
	v1_resource_rule_local_var->apiGroups = apiGroups;
	v1_resource_rule_local_var->resourceNames = resourceNames;
...
void v1_resource_rule_free(v1_resource_rule_t *v1_resource_rule) {
	...
	list_ForEach(listEntry, v1_resource_rule->apiGroups) {
		free(listEntry->data);
	}
	list_free(v1_resource_rule->apiGroups);
	list_ForEach(listEntry, v1_resource_rule->resourceNames) {
		free(listEntry->data);
	}
	list_free(v1_resource_rule->resourceNames);
...
cJSON *v1_resource_rule_convertToJSON(v1_resource_rule_t *v1_resource_rule) {
	...
	// v1_resource_rule->apiGroups
    if(v1_resource_rule->apiGroups) { 
    ...
    list_ForEach(api_groupsListEntry, v1_resource_rule->apiGroups) {
	...
	// v1_resource_rule->resourceNames
    if(v1_resource_rule->resourceNames) { 
    ...
    list_ForEach(resource_namesListEntry, v1_resource_rule->resourceNames) {
...
v1_resource_rule_t *v1_resource_rule_parseFromJSON(cJSON *v1_resource_ruleJSON){
    ...
    // v1_resource_rule->apiGroups
    cJSON *apiGroups = cJSON_GetObjectItemCaseSensitive(v1_resource_ruleJSON, "apiGroups");
    ...
    // v1_resource_rule->resourceNames
    cJSON *resourceNames = cJSON_GetObjectItemCaseSensitive(v1_resource_ruleJSON, "resourceNames");
