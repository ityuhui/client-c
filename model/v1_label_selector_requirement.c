...
v1_label_selector_requirement_t *v1_label_selector_requirement_create(
	...
	v1_label_selector_requirement_local_var->operator = operator;
...
void v1_label_selector_requirement_free(v1_label_selector_requirement_t *v1_label_selector_requirement) {
    ...
    free(v1_label_selector_requirement->operator);
...
cJSON *v1_label_selector_requirement_convertToJSON(v1_label_selector_requirement_t *v1_label_selector_requirement) {
	...
	// v1_label_selector_requirement->operator
    if (!v1_label_selector_requirement->operator) {
        goto fail;
    }
    
    if(cJSON_AddStringToObject(item, "operator", v1_label_selector_requirement->operator) == NULL) {
    goto fail; //String
    }
...
v1_label_selector_requirement_t *v1_label_selector_requirement_parseFromJSON(cJSON *v1_label_selector_requirementJSON){
    ...
    // v1_label_selector_requirement->operator
    cJSON *operator = cJSON_GetObjectItemCaseSensitive(v1_label_selector_requirementJSON, "operator");
    if (!operator) {
        goto end;
    }
