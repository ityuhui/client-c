...
v1alpha1_priority_class_t *v1alpha1_priority_class_create(
	...
	v1alpha1_priority_class_local_var->apiVersion = apiVersion;
	v1alpha1_priority_class_local_var->description = description;
	v1alpha1_priority_class_local_var->globalDefault = globalDefault;
	v1alpha1_priority_class_local_var->kind = kind;
	v1alpha1_priority_class_local_var->metadata = metadata;
	v1alpha1_priority_class_local_var->preemptionPolicy = preemptionPolicy;
...
void v1alpha1_priority_class_free(v1alpha1_priority_class_t *v1alpha1_priority_class) {
    ...
    free(v1alpha1_priority_class->apiVersion);
    ...
    free(v1alpha1_priority_class->preemptionPolicy);
...
cJSON *v1alpha1_priority_class_convertToJSON(v1alpha1_priority_class_t *v1alpha1_priority_class) {
	...
	// v1alpha1_priority_class->apiVersion
    if(v1alpha1_priority_class->apiVersion) { 
    if(cJSON_AddStringToObject(item, "apiVersion", v1alpha1_priority_class->apiVersion) == NULL) {
    goto fail; //String
    }
     } 
	...
	// v1alpha1_priority_class->globalDefault
    if(v1alpha1_priority_class->globalDefault) { 
    if(cJSON_AddBoolToObject(item, "globalDefault", v1alpha1_priority_class->globalDefault) == NULL) {
    goto fail; //Bool
    }
     } 
	...
	// v1alpha1_priority_class->preemptionPolicy
    if(v1alpha1_priority_class->preemptionPolicy) { 
    if(cJSON_AddStringToObject(item, "preemptionPolicy", v1alpha1_priority_class->preemptionPolicy) == NULL) {
    goto fail; //String
    }
     } 
...
v1alpha1_priority_class_t *v1alpha1_priority_class_parseFromJSON(cJSON *v1alpha1_priority_classJSON){
    ...
    // v1alpha1_priority_class->apiVersion
    cJSON *apiVersion = cJSON_GetObjectItemCaseSensitive(v1alpha1_priority_classJSON, "apiVersion");
    if (apiVersion) { 
    ...
    // v1alpha1_priority_class->globalDefault
    cJSON *globalDefault = cJSON_GetObjectItemCaseSensitive(v1alpha1_priority_classJSON, "globalDefault");
    if (globalDefault) { 
    ...
    // v1alpha1_priority_class->preemptionPolicy
    cJSON *preemptionPolicy = cJSON_GetObjectItemCaseSensitive(v1alpha1_priority_classJSON, "preemptionPolicy");
    if (preemptionPolicy) { 
