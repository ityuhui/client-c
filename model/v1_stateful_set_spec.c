...
v1_stateful_set_spec_t *v1_stateful_set_spec_create(
    ...
    v1_stateful_set_update_strategy_t *updateStrategy,
	...
	v1_stateful_set_spec_local_var->podManagementPolicy = podManagementPolicy;
	v1_stateful_set_spec_local_var->replicas = replicas;
	v1_stateful_set_spec_local_var->revisionHistoryLimit = revisionHistoryLimit;
	v1_stateful_set_spec_local_var->selector = selector;
	v1_stateful_set_spec_local_var->serviceName = serviceName;
	v1_stateful_set_spec_local_var->template = template;
	v1_stateful_set_spec_local_var->updateStrategy = updateStrategy;
	v1_stateful_set_spec_local_var->volumeClaimTemplates = volumeClaimTemplates;
...
void v1_stateful_set_spec_free(v1_stateful_set_spec_t *v1_stateful_set_spec) {
    ...
    free(v1_stateful_set_spec->podManagementPolicy);
    v1_label_selector_free(v1_stateful_set_spec->selector);
    free(v1_stateful_set_spec->serviceName);
    v1_pod_template_spec_free(v1_stateful_set_spec->template);
    v1_stateful_set_update_strategy_free(v1_stateful_set_spec->updateStrategy);
	list_ForEach(listEntry, v1_stateful_set_spec->volumeClaimTemplates) {
		v1_persistent_volume_claim_free(listEntry->data);
	}
	list_free(v1_stateful_set_spec->volumeClaimTemplates);
...
cJSON *v1_stateful_set_spec_convertToJSON(v1_stateful_set_spec_t *v1_stateful_set_spec) {
	...
	// v1_stateful_set_spec->podManagementPolicy
    if(v1_stateful_set_spec->podManagementPolicy) { 
    if(cJSON_AddStringToObject(item, "podManagementPolicy", v1_stateful_set_spec->podManagementPolicy) == NULL) {
    goto fail; //String
    }
     } 
	...
	// v1_stateful_set_spec->revisionHistoryLimit
    if(v1_stateful_set_spec->revisionHistoryLimit) { 
    if(cJSON_AddNumberToObject(item, "revisionHistoryLimit", v1_stateful_set_spec->revisionHistoryLimit) == NULL) {
    goto fail; //Numeric
    }
     } 
	...
	// v1_stateful_set_spec->serviceName
    if (!v1_stateful_set_spec->serviceName) {
        goto fail;
    }
    
    if(cJSON_AddStringToObject(item, "serviceName", v1_stateful_set_spec->serviceName) == NULL) {
    goto fail; //String
    }


	// v1_stateful_set_spec->template
    if (!v1_stateful_set_spec->template) {
        goto fail;
    }
    
    cJSON *template_local_JSON = v1_pod_template_spec_convertToJSON(v1_stateful_set_spec->template);
	...
	// v1_stateful_set_spec->updateStrategy
    if(v1_stateful_set_spec->updateStrategy) { 
    cJSON *updateStrategy_local_JSON = v1_stateful_set_update_strategy_convertToJSON(v1_stateful_set_spec->updateStrategy);
	...
	// v1_stateful_set_spec->volumeClaimTemplates
    if(v1_stateful_set_spec->volumeClaimTemplates) { 
    ...
    if (v1_stateful_set_spec->volumeClaimTemplates) {
    list_ForEach(volumeClaimTemplatesListEntry, v1_stateful_set_spec->volumeClaimTemplates) {
...
v1_stateful_set_spec_t *v1_stateful_set_spec_parseFromJSON(cJSON *v1_stateful_set_specJSON){
    ...
    // v1_stateful_set_spec->podManagementPolicy
    cJSON *podManagementPolicy = cJSON_GetObjectItemCaseSensitive(v1_stateful_set_specJSON, "podManagementPolicy");
    ...
    // v1_stateful_set_spec->revisionHistoryLimit
    cJSON *revisionHistoryLimit = cJSON_GetObjectItemCaseSensitive(v1_stateful_set_specJSON, "revisionHistoryLimit");
    ...
    // v1_stateful_set_spec->serviceName
    cJSON *serviceName = cJSON_GetObjectItemCaseSensitive(v1_stateful_set_specJSON, "serviceName");
    if (!serviceName) {
        goto end;
    }
    ...
    // v1_stateful_set_spec->template
    cJSON *template = cJSON_GetObjectItemCaseSensitive(v1_stateful_set_specJSON, "template");
    if (!template) {
        goto end;
    }
    ...
    // v1_stateful_set_spec->updateStrategy
    cJSON *updateStrategy = cJSON_GetObjectItemCaseSensitive(v1_stateful_set_specJSON, "updateStrategy");
    v1_stateful_set_update_strategy_t *updateStrategy_local_nonprim = NULL;
    if (updateStrategy) { 
    updateStrategy_local_nonprim = v1_stateful_set_update_strategy_parseFromJSON(updateStrategy); //nonprimitive
    }

    // v1_stateful_set_spec->volumeClaimTemplates
    cJSON *volumeClaimTemplates = cJSON_GetObjectItemCaseSensitive(v1_stateful_set_specJSON, "volumeClaimTemplates");
