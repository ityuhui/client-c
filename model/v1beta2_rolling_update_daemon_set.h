/*
 * v1beta2_rolling_update_daemon_set.h
 *
 * Spec to control the desired behavior of daemon set rolling update.
 */

#ifndef _v1beta2_rolling_update_daemon_set_H_
#define _v1beta2_rolling_update_daemon_set_H_
...
typedef struct v1beta2_rolling_update_daemon_set_t {
    object_t *maxUnavailable; //object

} v1beta2_rolling_update_daemon_set_t;
...
#endif /* _v1beta2_rolling_update_daemon_set_H_ */
