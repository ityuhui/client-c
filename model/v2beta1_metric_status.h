...
typedef struct v2beta1_metric_status_t {
    v2beta1_external_metric_status_t *external; //model
    v2beta1_object_metric_status_t *object; //model
    v2beta1_pods_metric_status_t *pods; //model
    v2beta1_resource_metric_status_t *resource; //model
    char *type; // string
