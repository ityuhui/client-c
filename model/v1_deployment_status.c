...
v1_deployment_status_t *v1_deployment_status_create(
	...
	v1_deployment_status_local_var->availableReplicas = availableReplicas;
	v1_deployment_status_local_var->collisionCount = collisionCount;
	v1_deployment_status_local_var->conditions = conditions;
	v1_deployment_status_local_var->observedGeneration = observedGeneration;
	v1_deployment_status_local_var->readyReplicas = readyReplicas;
	v1_deployment_status_local_var->replicas = replicas;
	v1_deployment_status_local_var->unavailableReplicas = unavailableReplicas;
	v1_deployment_status_local_var->updatedReplicas = updatedReplicas;
...
cJSON *v1_deployment_status_convertToJSON(v1_deployment_status_t *v1_deployment_status) {
	...
	// v1_deployment_status->availableReplicas
    if(v1_deployment_status->availableReplicas) { 
    if(cJSON_AddNumberToObject(item, "availableReplicas", v1_deployment_status->availableReplicas) == NULL) {
    goto fail; //Numeric
    }
     } 


	// v1_deployment_status->collisionCount
    if(v1_deployment_status->collisionCount) { 
    if(cJSON_AddNumberToObject(item, "collisionCount", v1_deployment_status->collisionCount) == NULL) {
    goto fail; //Numeric
    }
     } 
	...
	// v1_deployment_status->observedGeneration
    if(v1_deployment_status->observedGeneration) { 
    if(cJSON_AddNumberToObject(item, "observedGeneration", v1_deployment_status->observedGeneration) == NULL) {
    goto fail; //Numeric
    }
     } 


	// v1_deployment_status->readyReplicas
    if(v1_deployment_status->readyReplicas) { 
    if(cJSON_AddNumberToObject(item, "readyReplicas", v1_deployment_status->readyReplicas) == NULL) {
    goto fail; //Numeric
    }
     } 
	...
	// v1_deployment_status->unavailableReplicas
    if(v1_deployment_status->unavailableReplicas) { 
    if(cJSON_AddNumberToObject(item, "unavailableReplicas", v1_deployment_status->unavailableReplicas) == NULL) {
    goto fail; //Numeric
    }
     } 


	// v1_deployment_status->updatedReplicas
    if(v1_deployment_status->updatedReplicas) { 
    if(cJSON_AddNumberToObject(item, "updatedReplicas", v1_deployment_status->updatedReplicas) == NULL) {
    goto fail; //Numeric
    }
     } 
...
v1_deployment_status_t *v1_deployment_status_parseFromJSON(cJSON *v1_deployment_statusJSON){
    ...
    // v1_deployment_status->availableReplicas
    cJSON *availableReplicas = cJSON_GetObjectItemCaseSensitive(v1_deployment_statusJSON, "availableReplicas");
    ...
    // v1_deployment_status->collisionCount
    cJSON *collisionCount = cJSON_GetObjectItemCaseSensitive(v1_deployment_statusJSON, "collisionCount");
    if (collisionCount) { 
    ...
    // v1_deployment_status->observedGeneration
    cJSON *observedGeneration = cJSON_GetObjectItemCaseSensitive(v1_deployment_statusJSON, "observedGeneration");
    ...
    // v1_deployment_status->readyReplicas
    cJSON *readyReplicas = cJSON_GetObjectItemCaseSensitive(v1_deployment_statusJSON, "readyReplicas");
    if (readyReplicas) { 
    ...
    // v1_deployment_status->unavailableReplicas
    cJSON *unavailableReplicas = cJSON_GetObjectItemCaseSensitive(v1_deployment_statusJSON, "unavailableReplicas");
    ...
    // v1_deployment_status->updatedReplicas
    cJSON *updatedReplicas = cJSON_GetObjectItemCaseSensitive(v1_deployment_statusJSON, "updatedReplicas");
    if (updatedReplicas) { 
