...
v1_self_subject_rules_review_t *v1_self_subject_rules_review_create(
	...
	v1_self_subject_rules_review_local_var->apiVersion = apiVersion;
...
void v1_self_subject_rules_review_free(v1_self_subject_rules_review_t *v1_self_subject_rules_review) {
    ...
    free(v1_self_subject_rules_review->apiVersion);
...
cJSON *v1_self_subject_rules_review_convertToJSON(v1_self_subject_rules_review_t *v1_self_subject_rules_review) {
	...
	// v1_self_subject_rules_review->apiVersion
    if(v1_self_subject_rules_review->apiVersion) { 
    if(cJSON_AddStringToObject(item, "apiVersion", v1_self_subject_rules_review->apiVersion) == NULL) {
    goto fail; //String
    }
     } 
    ...
    if(cJSON_AddStringToObject(item, "kind", v1_self_subject_rules_review->kind) == NULL) {
    goto fail; //String
    }
     } 
    ...
    cJSON *metadata_local_JSON = v1_object_meta_convertToJSON(v1_self_subject_rules_review->metadata);
    ...
    cJSON *spec_local_JSON = v1_self_subject_rules_review_spec_convertToJSON(v1_self_subject_rules_review->spec);
    ...
    cJSON *status_local_JSON = v1_subject_rules_review_status_convertToJSON(v1_self_subject_rules_review->status);
...
v1_self_subject_rules_review_t *v1_self_subject_rules_review_parseFromJSON(cJSON *v1_self_subject_rules_reviewJSON){
    ...
    // v1_self_subject_rules_review->apiVersion
    cJSON *apiVersion = cJSON_GetObjectItemCaseSensitive(v1_self_subject_rules_reviewJSON, "apiVersion");
    if (apiVersion) { 
    ...
    // v1_self_subject_rules_review->kind
    cJSON *kind = cJSON_GetObjectItemCaseSensitive(v1_self_subject_rules_reviewJSON, "kind");
    if (kind) { 
    ...
    // v1_self_subject_rules_review->spec
    cJSON *spec = cJSON_GetObjectItemCaseSensitive(v1_self_subject_rules_reviewJSON, "spec");
    if (!spec) {
        goto end;
    }
