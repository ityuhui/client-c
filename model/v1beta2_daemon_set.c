...
v1beta2_daemon_set_t *v1beta2_daemon_set_create(
	...
	v1beta2_daemon_set_local_var->apiVersion = apiVersion;
...
void v1beta2_daemon_set_free(v1beta2_daemon_set_t *v1beta2_daemon_set) {
    ...
    free(v1beta2_daemon_set->apiVersion);
...
cJSON *v1beta2_daemon_set_convertToJSON(v1beta2_daemon_set_t *v1beta2_daemon_set) {
	...
	// v1beta2_daemon_set->apiVersion
    if(v1beta2_daemon_set->apiVersion) { 
    if(cJSON_AddStringToObject(item, "apiVersion", v1beta2_daemon_set->apiVersion) == NULL) {
    goto fail; //String
    }
     } 
...
v1beta2_daemon_set_t *v1beta2_daemon_set_parseFromJSON(cJSON *v1beta2_daemon_setJSON){
    ...
    // v1beta2_daemon_set->apiVersion
    cJSON *apiVersion = cJSON_GetObjectItemCaseSensitive(v1beta2_daemon_setJSON, "apiVersion");
    if (apiVersion) { 
