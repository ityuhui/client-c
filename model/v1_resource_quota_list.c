...
v1_resource_quota_list_t *v1_resource_quota_list_create(
	...
	v1_resource_quota_list_local_var->apiVersion = apiVersion;
...
void v1_resource_quota_list_free(v1_resource_quota_list_t *v1_resource_quota_list) {
    ...
    free(v1_resource_quota_list->apiVersion);
...
cJSON *v1_resource_quota_list_convertToJSON(v1_resource_quota_list_t *v1_resource_quota_list) {
	...
	// v1_resource_quota_list->apiVersion
    if(v1_resource_quota_list->apiVersion) { 
    if(cJSON_AddStringToObject(item, "apiVersion", v1_resource_quota_list->apiVersion) == NULL) {
    goto fail; //String
    }
     } 
...
v1_resource_quota_list_t *v1_resource_quota_list_parseFromJSON(cJSON *v1_resource_quota_listJSON){
    ...
    // v1_resource_quota_list->apiVersion
    cJSON *apiVersion = cJSON_GetObjectItemCaseSensitive(v1_resource_quota_listJSON, "apiVersion");
    if (apiVersion) { 
