...
v1_custom_resource_definition_spec_t *v1_custom_resource_definition_spec_create(
	...
	v1_custom_resource_definition_spec_local_var->preserveUnknownFields = preserveUnknownFields;
...
cJSON *v1_custom_resource_definition_spec_convertToJSON(v1_custom_resource_definition_spec_t *v1_custom_resource_definition_spec) {
	...
	// v1_custom_resource_definition_spec->preserveUnknownFields
    if(v1_custom_resource_definition_spec->preserveUnknownFields) { 
    if(cJSON_AddBoolToObject(item, "preserveUnknownFields", v1_custom_resource_definition_spec->preserveUnknownFields) == NULL) {
    goto fail; //Bool
    }
     } 
...
v1_custom_resource_definition_spec_t *v1_custom_resource_definition_spec_parseFromJSON(cJSON *v1_custom_resource_definition_specJSON){
    ...
    // v1_custom_resource_definition_spec->preserveUnknownFields
    cJSON *preserveUnknownFields = cJSON_GetObjectItemCaseSensitive(v1_custom_resource_definition_specJSON, "preserveUnknownFields");
