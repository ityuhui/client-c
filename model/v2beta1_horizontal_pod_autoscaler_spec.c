...
v2beta1_horizontal_pod_autoscaler_spec_t *v2beta1_horizontal_pod_autoscaler_spec_create(
    ...
    list_t *metrics,
    int minReplicas,
    v2beta1_cross_version_object_reference_t *scaleTargetRef
    ) {
	...
	v2beta1_horizontal_pod_autoscaler_spec_local_var->maxReplicas = maxReplicas;
	v2beta1_horizontal_pod_autoscaler_spec_local_var->metrics = metrics;
	v2beta1_horizontal_pod_autoscaler_spec_local_var->minReplicas = minReplicas;
	v2beta1_horizontal_pod_autoscaler_spec_local_var->scaleTargetRef = scaleTargetRef;
...
void v2beta1_horizontal_pod_autoscaler_spec_free(v2beta1_horizontal_pod_autoscaler_spec_t *v2beta1_horizontal_pod_autoscaler_spec) {
    ...
    v2beta1_cross_version_object_reference_free(v2beta1_horizontal_pod_autoscaler_spec->scaleTargetRef);
...
cJSON *v2beta1_horizontal_pod_autoscaler_spec_convertToJSON(v2beta1_horizontal_pod_autoscaler_spec_t *v2beta1_horizontal_pod_autoscaler_spec) {
	...
	// v2beta1_horizontal_pod_autoscaler_spec->maxReplicas
    if (!v2beta1_horizontal_pod_autoscaler_spec->maxReplicas) {
        goto fail;
    }
    
    if(cJSON_AddNumberToObject(item, "maxReplicas", v2beta1_horizontal_pod_autoscaler_spec->maxReplicas) == NULL) {
    goto fail; //Numeric
    }
	...
	// v2beta1_horizontal_pod_autoscaler_spec->minReplicas
    if(v2beta1_horizontal_pod_autoscaler_spec->minReplicas) { 
    if(cJSON_AddNumberToObject(item, "minReplicas", v2beta1_horizontal_pod_autoscaler_spec->minReplicas) == NULL) {
    goto fail; //Numeric
    }
     } 


	// v2beta1_horizontal_pod_autoscaler_spec->scaleTargetRef
    if (!v2beta1_horizontal_pod_autoscaler_spec->scaleTargetRef) {
        goto fail;
    }
    
    cJSON *scaleTargetRef_local_JSON = v2beta1_cross_version_object_reference_convertToJSON(v2beta1_horizontal_pod_autoscaler_spec->scaleTargetRef);
...
v2beta1_horizontal_pod_autoscaler_spec_t *v2beta1_horizontal_pod_autoscaler_spec_parseFromJSON(cJSON *v2beta1_horizontal_pod_autoscaler_specJSON){
    ...
    // v2beta1_horizontal_pod_autoscaler_spec->maxReplicas
    cJSON *maxReplicas = cJSON_GetObjectItemCaseSensitive(v2beta1_horizontal_pod_autoscaler_specJSON, "maxReplicas");
    if (!maxReplicas) {
        goto end;
    }
    ...
    // v2beta1_horizontal_pod_autoscaler_spec->minReplicas
    cJSON *minReplicas = cJSON_GetObjectItemCaseSensitive(v2beta1_horizontal_pod_autoscaler_specJSON, "minReplicas");
    if (minReplicas) { 
    ...
    // v2beta1_horizontal_pod_autoscaler_spec->scaleTargetRef
    cJSON *scaleTargetRef = cJSON_GetObjectItemCaseSensitive(v2beta1_horizontal_pod_autoscaler_specJSON, "scaleTargetRef");
    if (!scaleTargetRef) {
        goto end;
    }

    v2beta1_cross_version_object_reference_t *scaleTargetRef_local_nonprim = NULL;
    
    scaleTargetRef_local_nonprim = v2beta1_cross_version_object_reference_parseFromJSON(scaleTargetRef); //nonprimitive
