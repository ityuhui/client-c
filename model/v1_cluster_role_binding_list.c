...
v1_cluster_role_binding_list_t *v1_cluster_role_binding_list_create(
	...
	v1_cluster_role_binding_list_local_var->apiVersion = apiVersion;
...
void v1_cluster_role_binding_list_free(v1_cluster_role_binding_list_t *v1_cluster_role_binding_list) {
    ...
    free(v1_cluster_role_binding_list->apiVersion);
...
cJSON *v1_cluster_role_binding_list_convertToJSON(v1_cluster_role_binding_list_t *v1_cluster_role_binding_list) {
	...
	// v1_cluster_role_binding_list->apiVersion
    if(v1_cluster_role_binding_list->apiVersion) { 
    if(cJSON_AddStringToObject(item, "apiVersion", v1_cluster_role_binding_list->apiVersion) == NULL) {
    goto fail; //String
    }
     } 
...
v1_cluster_role_binding_list_t *v1_cluster_role_binding_list_parseFromJSON(cJSON *v1_cluster_role_binding_listJSON){
    ...
    // v1_cluster_role_binding_list->apiVersion
    cJSON *apiVersion = cJSON_GetObjectItemCaseSensitive(v1_cluster_role_binding_listJSON, "apiVersion");
    if (apiVersion) { 
