...
v1_ephemeral_container_t *v1_ephemeral_container_create(
	...
	v1_ephemeral_container_local_var->envFrom = envFrom;
	v1_ephemeral_container_local_var->image = image;
	v1_ephemeral_container_local_var->imagePullPolicy = imagePullPolicy;
	v1_ephemeral_container_local_var->lifecycle = lifecycle;
	v1_ephemeral_container_local_var->livenessProbe = livenessProbe;
	v1_ephemeral_container_local_var->name = name;
	v1_ephemeral_container_local_var->ports = ports;
	v1_ephemeral_container_local_var->readinessProbe = readinessProbe;
	v1_ephemeral_container_local_var->resources = resources;
	v1_ephemeral_container_local_var->securityContext = securityContext;
	v1_ephemeral_container_local_var->startupProbe = startupProbe;
	v1_ephemeral_container_local_var->stdin = stdin;
	v1_ephemeral_container_local_var->stdinOnce = stdinOnce;
	v1_ephemeral_container_local_var->targetContainerName = targetContainerName;
	v1_ephemeral_container_local_var->terminationMessagePath = terminationMessagePath;
	v1_ephemeral_container_local_var->terminationMessagePolicy = terminationMessagePolicy;
	v1_ephemeral_container_local_var->tty = tty;
	v1_ephemeral_container_local_var->volumeDevices = volumeDevices;
	v1_ephemeral_container_local_var->volumeMounts = volumeMounts;
	v1_ephemeral_container_local_var->workingDir = workingDir;
...
void v1_ephemeral_container_free(v1_ephemeral_container_t *v1_ephemeral_container) {
	...
	list_ForEach(listEntry, v1_ephemeral_container->envFrom) {
		v1_env_from_source_free(listEntry->data);
	}
	list_free(v1_ephemeral_container->envFrom);
    free(v1_ephemeral_container->image);
    free(v1_ephemeral_container->imagePullPolicy);
    v1_lifecycle_free(v1_ephemeral_container->lifecycle);
    v1_probe_free(v1_ephemeral_container->livenessProbe);
    ...
    v1_probe_free(v1_ephemeral_container->readinessProbe);
    v1_resource_requirements_free(v1_ephemeral_container->resources);
    v1_security_context_free(v1_ephemeral_container->securityContext);
    v1_probe_free(v1_ephemeral_container->startupProbe);
    free(v1_ephemeral_container->targetContainerName);
    free(v1_ephemeral_container->terminationMessagePath);
    free(v1_ephemeral_container->terminationMessagePolicy);
	list_ForEach(listEntry, v1_ephemeral_container->volumeDevices) {
		v1_volume_device_free(listEntry->data);
	}
	list_free(v1_ephemeral_container->volumeDevices);
	list_ForEach(listEntry, v1_ephemeral_container->volumeMounts) {
		v1_volume_mount_free(listEntry->data);
	}
	list_free(v1_ephemeral_container->volumeMounts);
    free(v1_ephemeral_container->workingDir);
...
cJSON *v1_ephemeral_container_convertToJSON(v1_ephemeral_container_t *v1_ephemeral_container) {
	...
	// v1_ephemeral_container->envFrom
    if(v1_ephemeral_container->envFrom) { 
    ...
    if (v1_ephemeral_container->envFrom) {
    list_ForEach(envFromListEntry, v1_ephemeral_container->envFrom) {
	...
	// v1_ephemeral_container->imagePullPolicy
    if(v1_ephemeral_container->imagePullPolicy) { 
    if(cJSON_AddStringToObject(item, "imagePullPolicy", v1_ephemeral_container->imagePullPolicy) == NULL) {
    goto fail; //String
    }
     } 
	...
	// v1_ephemeral_container->livenessProbe
    if(v1_ephemeral_container->livenessProbe) { 
    cJSON *livenessProbe_local_JSON = v1_probe_convertToJSON(v1_ephemeral_container->livenessProbe);
	...
	// v1_ephemeral_container->readinessProbe
    if(v1_ephemeral_container->readinessProbe) { 
    cJSON *readinessProbe_local_JSON = v1_probe_convertToJSON(v1_ephemeral_container->readinessProbe);
	...
	// v1_ephemeral_container->securityContext
    if(v1_ephemeral_container->securityContext) { 
    cJSON *securityContext_local_JSON = v1_security_context_convertToJSON(v1_ephemeral_container->securityContext);
	...
	// v1_ephemeral_container->startupProbe
    if(v1_ephemeral_container->startupProbe) { 
    cJSON *startupProbe_local_JSON = v1_probe_convertToJSON(v1_ephemeral_container->startupProbe);
	...
	// v1_ephemeral_container->stdin
    if(v1_ephemeral_container->stdin) { 
    if(cJSON_AddBoolToObject(item, "stdin", v1_ephemeral_container->stdin) == NULL) {
    goto fail; //Bool
    }
     } 


	// v1_ephemeral_container->stdinOnce
    if(v1_ephemeral_container->stdinOnce) { 
    if(cJSON_AddBoolToObject(item, "stdinOnce", v1_ephemeral_container->stdinOnce) == NULL) {
    goto fail; //Bool
    }
     } 


	// v1_ephemeral_container->targetContainerName
    if(v1_ephemeral_container->targetContainerName) { 
    if(cJSON_AddStringToObject(item, "targetContainerName", v1_ephemeral_container->targetContainerName) == NULL) {
    goto fail; //String
    }
     } 


	// v1_ephemeral_container->terminationMessagePath
    if(v1_ephemeral_container->terminationMessagePath) { 
    if(cJSON_AddStringToObject(item, "terminationMessagePath", v1_ephemeral_container->terminationMessagePath) == NULL) {
    goto fail; //String
    }
     } 


	// v1_ephemeral_container->terminationMessagePolicy
    if(v1_ephemeral_container->terminationMessagePolicy) { 
    if(cJSON_AddStringToObject(item, "terminationMessagePolicy", v1_ephemeral_container->terminationMessagePolicy) == NULL) {
    goto fail; //String
    }
     } 
	...
	// v1_ephemeral_container->volumeDevices
    if(v1_ephemeral_container->volumeDevices) { 
    ...
    if (v1_ephemeral_container->volumeDevices) {
    list_ForEach(volumeDevicesListEntry, v1_ephemeral_container->volumeDevices) {
	...
	// v1_ephemeral_container->volumeMounts
    if(v1_ephemeral_container->volumeMounts) { 
    ...
    if (v1_ephemeral_container->volumeMounts) {
    list_ForEach(volumeMountsListEntry, v1_ephemeral_container->volumeMounts) {
	...
	// v1_ephemeral_container->workingDir
    if(v1_ephemeral_container->workingDir) { 
    if(cJSON_AddStringToObject(item, "workingDir", v1_ephemeral_container->workingDir) == NULL) {
    goto fail; //String
    }
     } 
...
v1_ephemeral_container_t *v1_ephemeral_container_parseFromJSON(cJSON *v1_ephemeral_containerJSON){
    ...
    // v1_ephemeral_container->envFrom
    cJSON *envFrom = cJSON_GetObjectItemCaseSensitive(v1_ephemeral_containerJSON, "envFrom");
    list_t *envFromList;
    if (envFrom) { 
    ...
    // v1_ephemeral_container->imagePullPolicy
    cJSON *imagePullPolicy = cJSON_GetObjectItemCaseSensitive(v1_ephemeral_containerJSON, "imagePullPolicy");
    if (imagePullPolicy) { 
    ...
    // v1_ephemeral_container->livenessProbe
    cJSON *livenessProbe = cJSON_GetObjectItemCaseSensitive(v1_ephemeral_containerJSON, "livenessProbe");
    ...
    // v1_ephemeral_container->readinessProbe
    cJSON *readinessProbe = cJSON_GetObjectItemCaseSensitive(v1_ephemeral_containerJSON, "readinessProbe");
    ...
    // v1_ephemeral_container->securityContext
    cJSON *securityContext = cJSON_GetObjectItemCaseSensitive(v1_ephemeral_containerJSON, "securityContext");
    ...
    // v1_ephemeral_container->startupProbe
    cJSON *startupProbe = cJSON_GetObjectItemCaseSensitive(v1_ephemeral_containerJSON, "startupProbe");
    ...
    // v1_ephemeral_container->stdin
    cJSON *stdin = cJSON_GetObjectItemCaseSensitive(v1_ephemeral_containerJSON, "stdin");
    if (stdin) { 
    ...
    // v1_ephemeral_container->stdinOnce
    cJSON *stdinOnce = cJSON_GetObjectItemCaseSensitive(v1_ephemeral_containerJSON, "stdinOnce");
    if (stdinOnce) { 
    ...
    // v1_ephemeral_container->targetContainerName
    cJSON *targetContainerName = cJSON_GetObjectItemCaseSensitive(v1_ephemeral_containerJSON, "targetContainerName");
    if (targetContainerName) { 
    if(!cJSON_IsString(targetContainerName))
    {
    goto end; //String
    }
    }
    ...
    // v1_ephemeral_container->terminationMessagePath
    cJSON *terminationMessagePath = cJSON_GetObjectItemCaseSensitive(v1_ephemeral_containerJSON, "terminationMessagePath");
    ...
    // v1_ephemeral_container->terminationMessagePolicy
    cJSON *terminationMessagePolicy = cJSON_GetObjectItemCaseSensitive(v1_ephemeral_containerJSON, "terminationMessagePolicy");
    ...
    // v1_ephemeral_container->volumeDevices
    cJSON *volumeDevices = cJSON_GetObjectItemCaseSensitive(v1_ephemeral_containerJSON, "volumeDevices");
    ...
    // v1_ephemeral_container->volumeMounts
    cJSON *volumeMounts = cJSON_GetObjectItemCaseSensitive(v1_ephemeral_containerJSON, "volumeMounts");
    ...
    // v1_ephemeral_container->workingDir
    cJSON *workingDir = cJSON_GetObjectItemCaseSensitive(v1_ephemeral_containerJSON, "workingDir");
    if (workingDir) { 
    ...
    v1_ephemeral_container_local_var = v1_ephemeral_container_create (
        ...
        targetContainerName ? strdup(targetContainerName->valuestring) : NULL,
