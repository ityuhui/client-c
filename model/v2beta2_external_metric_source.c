...
v2beta2_external_metric_source_t *v2beta2_external_metric_source_create(
	...
	v2beta2_external_metric_source_t *v2beta2_external_metric_source_local_var = malloc(sizeof(v2beta2_external_metric_source_t));
    if (!v2beta2_external_metric_source_local_var) {
        return NULL;
    }
	v2beta2_external_metric_source_local_var->metric = metric;
	v2beta2_external_metric_source_local_var->target = target;
...
void v2beta2_external_metric_source_free(v2beta2_external_metric_source_t *v2beta2_external_metric_source) {
    ...
    v2beta2_metric_identifier_free(v2beta2_external_metric_source->metric);
    v2beta2_metric_target_free(v2beta2_external_metric_source->target);
	free(v2beta2_external_metric_source);
}
...
cJSON *v2beta2_external_metric_source_convertToJSON(v2beta2_external_metric_source_t *v2beta2_external_metric_source) {
    ...
    if (!v2beta2_external_metric_source->metric) {
        goto fail;
    }
    
    cJSON *metric_local_JSON = v2beta2_metric_identifier_convertToJSON(v2beta2_external_metric_source->metric);
	...
	// v2beta2_external_metric_source->target
    if (!v2beta2_external_metric_source->target) {
        goto fail;
    }
    
    cJSON *target_local_JSON = v2beta2_metric_target_convertToJSON(v2beta2_external_metric_source->target);
...
v2beta2_external_metric_source_t *v2beta2_external_metric_source_parseFromJSON(cJSON *v2beta2_external_metric_sourceJSON){
    ...
    // v2beta2_external_metric_source->target
    cJSON *target = cJSON_GetObjectItemCaseSensitive(v2beta2_external_metric_sourceJSON, "target");
    if (!target) {
        goto end;
    }
    ...
    v2beta2_external_metric_source_local_var = v2beta2_external_metric_source_create (
