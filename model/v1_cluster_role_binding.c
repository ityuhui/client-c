...
v1_cluster_role_binding_t *v1_cluster_role_binding_create(
	...
	v1_cluster_role_binding_local_var->apiVersion = apiVersion;
	v1_cluster_role_binding_local_var->kind = kind;
	v1_cluster_role_binding_local_var->metadata = metadata;
	v1_cluster_role_binding_local_var->roleRef = roleRef;
...
void v1_cluster_role_binding_free(v1_cluster_role_binding_t *v1_cluster_role_binding) {
    ...
    free(v1_cluster_role_binding->apiVersion);
    free(v1_cluster_role_binding->kind);
    v1_object_meta_free(v1_cluster_role_binding->metadata);
    v1_role_ref_free(v1_cluster_role_binding->roleRef);
...
cJSON *v1_cluster_role_binding_convertToJSON(v1_cluster_role_binding_t *v1_cluster_role_binding) {
	...
	// v1_cluster_role_binding->apiVersion
    if(v1_cluster_role_binding->apiVersion) { 
    if(cJSON_AddStringToObject(item, "apiVersion", v1_cluster_role_binding->apiVersion) == NULL) {
    goto fail; //String
    }
     } 
	...
	// v1_cluster_role_binding->roleRef
    if (!v1_cluster_role_binding->roleRef) {
        goto fail;
    }
    
    cJSON *roleRef_local_JSON = v1_role_ref_convertToJSON(v1_cluster_role_binding->roleRef);
...
v1_cluster_role_binding_t *v1_cluster_role_binding_parseFromJSON(cJSON *v1_cluster_role_bindingJSON){
    ...
    // v1_cluster_role_binding->apiVersion
    cJSON *apiVersion = cJSON_GetObjectItemCaseSensitive(v1_cluster_role_bindingJSON, "apiVersion");
    if (apiVersion) { 
    ...
    // v1_cluster_role_binding->roleRef
    cJSON *roleRef = cJSON_GetObjectItemCaseSensitive(v1_cluster_role_bindingJSON, "roleRef");
    if (!roleRef) {
        goto end;
    }

    v1_role_ref_t *roleRef_local_nonprim = NULL;
    
    roleRef_local_nonprim = v1_role_ref_parseFromJSON(roleRef); //nonprimitive
