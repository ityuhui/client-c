...
v1_pod_anti_affinity_t *v1_pod_anti_affinity_create(
	...
	v1_pod_anti_affinity_local_var->preferredDuringSchedulingIgnoredDuringExecution = preferredDuringSchedulingIgnoredDuringExecution;
	v1_pod_anti_affinity_local_var->requiredDuringSchedulingIgnoredDuringExecution = requiredDuringSchedulingIgnoredDuringExecution;
...
void v1_pod_anti_affinity_free(v1_pod_anti_affinity_t *v1_pod_anti_affinity) {
	...
	list_ForEach(listEntry, v1_pod_anti_affinity->preferredDuringSchedulingIgnoredDuringExecution) {
		v1_weighted_pod_affinity_term_free(listEntry->data);
	}
	list_free(v1_pod_anti_affinity->preferredDuringSchedulingIgnoredDuringExecution);
	list_ForEach(listEntry, v1_pod_anti_affinity->requiredDuringSchedulingIgnoredDuringExecution) {
		v1_pod_affinity_term_free(listEntry->data);
	}
	list_free(v1_pod_anti_affinity->requiredDuringSchedulingIgnoredDuringExecution);
...
cJSON *v1_pod_anti_affinity_convertToJSON(v1_pod_anti_affinity_t *v1_pod_anti_affinity) {
	...
	// v1_pod_anti_affinity->preferredDuringSchedulingIgnoredDuringExecution
    if(v1_pod_anti_affinity->preferredDuringSchedulingIgnoredDuringExecution) { 
    ...
    if (v1_pod_anti_affinity->preferredDuringSchedulingIgnoredDuringExecution) {
    list_ForEach(preferredDuringSchedulingIgnoredDuringExecutionListEntry, v1_pod_anti_affinity->preferredDuringSchedulingIgnoredDuringExecution) {
	...
	// v1_pod_anti_affinity->requiredDuringSchedulingIgnoredDuringExecution
    if(v1_pod_anti_affinity->requiredDuringSchedulingIgnoredDuringExecution) { 
    ...
    if (v1_pod_anti_affinity->requiredDuringSchedulingIgnoredDuringExecution) {
    list_ForEach(requiredDuringSchedulingIgnoredDuringExecutionListEntry, v1_pod_anti_affinity->requiredDuringSchedulingIgnoredDuringExecution) {
...
v1_pod_anti_affinity_t *v1_pod_anti_affinity_parseFromJSON(cJSON *v1_pod_anti_affinityJSON){
    ...
    // v1_pod_anti_affinity->preferredDuringSchedulingIgnoredDuringExecution
    cJSON *preferredDuringSchedulingIgnoredDuringExecution = cJSON_GetObjectItemCaseSensitive(v1_pod_anti_affinityJSON, "preferredDuringSchedulingIgnoredDuringExecution");
    ...
    // v1_pod_anti_affinity->requiredDuringSchedulingIgnoredDuringExecution
    cJSON *requiredDuringSchedulingIgnoredDuringExecution = cJSON_GetObjectItemCaseSensitive(v1_pod_anti_affinityJSON, "requiredDuringSchedulingIgnoredDuringExecution");
