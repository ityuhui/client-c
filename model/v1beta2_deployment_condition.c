...
v1beta2_deployment_condition_t *v1beta2_deployment_condition_create(
	...
	v1beta2_deployment_condition_local_var->lastTransitionTime = lastTransitionTime;
	v1beta2_deployment_condition_local_var->lastUpdateTime = lastUpdateTime;
...
void v1beta2_deployment_condition_free(v1beta2_deployment_condition_t *v1beta2_deployment_condition) {
    ...
    free(v1beta2_deployment_condition->lastTransitionTime);
    free(v1beta2_deployment_condition->lastUpdateTime);
...
cJSON *v1beta2_deployment_condition_convertToJSON(v1beta2_deployment_condition_t *v1beta2_deployment_condition) {
	...
	// v1beta2_deployment_condition->lastTransitionTime
    if(v1beta2_deployment_condition->lastTransitionTime) { 
    if(cJSON_AddStringToObject(item, "lastTransitionTime", v1beta2_deployment_condition->lastTransitionTime) == NULL) {
    goto fail; //Date-Time
    }
     } 


	// v1beta2_deployment_condition->lastUpdateTime
    if(v1beta2_deployment_condition->lastUpdateTime) { 
    if(cJSON_AddStringToObject(item, "lastUpdateTime", v1beta2_deployment_condition->lastUpdateTime) == NULL) {
    goto fail; //Date-Time
    }
     } 
...
v1beta2_deployment_condition_t *v1beta2_deployment_condition_parseFromJSON(cJSON *v1beta2_deployment_conditionJSON){
    ...
    // v1beta2_deployment_condition->lastTransitionTime
    cJSON *lastTransitionTime = cJSON_GetObjectItemCaseSensitive(v1beta2_deployment_conditionJSON, "lastTransitionTime");
    ...
    // v1beta2_deployment_condition->lastUpdateTime
    cJSON *lastUpdateTime = cJSON_GetObjectItemCaseSensitive(v1beta2_deployment_conditionJSON, "lastUpdateTime");
    if (lastUpdateTime) { 
