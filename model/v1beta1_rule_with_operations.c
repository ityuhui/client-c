...
v1beta1_rule_with_operations_t *v1beta1_rule_with_operations_create(
	...
	v1beta1_rule_with_operations_local_var->apiGroups = apiGroups;
	v1beta1_rule_with_operations_local_var->apiVersions = apiVersions;
...
void v1beta1_rule_with_operations_free(v1beta1_rule_with_operations_t *v1beta1_rule_with_operations) {
	...
	list_ForEach(listEntry, v1beta1_rule_with_operations->apiGroups) {
		free(listEntry->data);
	}
	list_free(v1beta1_rule_with_operations->apiGroups);
	list_ForEach(listEntry, v1beta1_rule_with_operations->apiVersions) {
		free(listEntry->data);
	}
	list_free(v1beta1_rule_with_operations->apiVersions);
...
cJSON *v1beta1_rule_with_operations_convertToJSON(v1beta1_rule_with_operations_t *v1beta1_rule_with_operations) {
	...
	// v1beta1_rule_with_operations->apiGroups
    if(v1beta1_rule_with_operations->apiGroups) { 
    ...
    list_ForEach(api_groupsListEntry, v1beta1_rule_with_operations->apiGroups) {
	...
	// v1beta1_rule_with_operations->apiVersions
    if(v1beta1_rule_with_operations->apiVersions) { 
    ...
    list_ForEach(api_versionsListEntry, v1beta1_rule_with_operations->apiVersions) {
...
v1beta1_rule_with_operations_t *v1beta1_rule_with_operations_parseFromJSON(cJSON *v1beta1_rule_with_operationsJSON){
    ...
    // v1beta1_rule_with_operations->apiGroups
    cJSON *apiGroups = cJSON_GetObjectItemCaseSensitive(v1beta1_rule_with_operationsJSON, "apiGroups");
    ...
    // v1beta1_rule_with_operations->apiVersions
    cJSON *apiVersions = cJSON_GetObjectItemCaseSensitive(v1beta1_rule_with_operationsJSON, "apiVersions");
