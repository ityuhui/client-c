...
v1beta1_non_resource_rule_t *v1beta1_non_resource_rule_create(
	...
	v1beta1_non_resource_rule_local_var->nonResourceURLs = nonResourceURLs;
...
void v1beta1_non_resource_rule_free(v1beta1_non_resource_rule_t *v1beta1_non_resource_rule) {
	...
	list_ForEach(listEntry, v1beta1_non_resource_rule->nonResourceURLs) {
		free(listEntry->data);
	}
	list_free(v1beta1_non_resource_rule->nonResourceURLs);
...
cJSON *v1beta1_non_resource_rule_convertToJSON(v1beta1_non_resource_rule_t *v1beta1_non_resource_rule) {
	...
	// v1beta1_non_resource_rule->nonResourceURLs
    if(v1beta1_non_resource_rule->nonResourceURLs) { 
    ...
    list_ForEach(non_resource_ur_lsListEntry, v1beta1_non_resource_rule->nonResourceURLs) {
...
v1beta1_non_resource_rule_t *v1beta1_non_resource_rule_parseFromJSON(cJSON *v1beta1_non_resource_ruleJSON){
    ...
    // v1beta1_non_resource_rule->nonResourceURLs
    cJSON *nonResourceURLs = cJSON_GetObjectItemCaseSensitive(v1beta1_non_resource_ruleJSON, "nonResourceURLs");
