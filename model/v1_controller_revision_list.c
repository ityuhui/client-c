...
v1_controller_revision_list_t *v1_controller_revision_list_create(
	...
	v1_controller_revision_list_local_var->apiVersion = apiVersion;
...
void v1_controller_revision_list_free(v1_controller_revision_list_t *v1_controller_revision_list) {
    ...
    free(v1_controller_revision_list->apiVersion);
...
cJSON *v1_controller_revision_list_convertToJSON(v1_controller_revision_list_t *v1_controller_revision_list) {
	...
	// v1_controller_revision_list->apiVersion
    if(v1_controller_revision_list->apiVersion) { 
    if(cJSON_AddStringToObject(item, "apiVersion", v1_controller_revision_list->apiVersion) == NULL) {
    goto fail; //String
    }
     } 
...
v1_controller_revision_list_t *v1_controller_revision_list_parseFromJSON(cJSON *v1_controller_revision_listJSON){
    ...
    // v1_controller_revision_list->apiVersion
    cJSON *apiVersion = cJSON_GetObjectItemCaseSensitive(v1_controller_revision_listJSON, "apiVersion");
    if (apiVersion) { 
