...
v1_daemon_set_list_t *v1_daemon_set_list_create(
	...
	v1_daemon_set_list_local_var->apiVersion = apiVersion;
...
void v1_daemon_set_list_free(v1_daemon_set_list_t *v1_daemon_set_list) {
    ...
    free(v1_daemon_set_list->apiVersion);
...
cJSON *v1_daemon_set_list_convertToJSON(v1_daemon_set_list_t *v1_daemon_set_list) {
	...
	// v1_daemon_set_list->apiVersion
    if(v1_daemon_set_list->apiVersion) { 
    if(cJSON_AddStringToObject(item, "apiVersion", v1_daemon_set_list->apiVersion) == NULL) {
    goto fail; //String
    }
     } 
...
v1_daemon_set_list_t *v1_daemon_set_list_parseFromJSON(cJSON *v1_daemon_set_listJSON){
    ...
    // v1_daemon_set_list->apiVersion
    cJSON *apiVersion = cJSON_GetObjectItemCaseSensitive(v1_daemon_set_listJSON, "apiVersion");
    if (apiVersion) { 
