...
v1beta2_deployment_strategy_t *v1beta2_deployment_strategy_create(
	...
	v1beta2_deployment_strategy_local_var->rollingUpdate = rollingUpdate;
...
void v1beta2_deployment_strategy_free(v1beta2_deployment_strategy_t *v1beta2_deployment_strategy) {
    ...
    v1beta2_rolling_update_deployment_free(v1beta2_deployment_strategy->rollingUpdate);
...
cJSON *v1beta2_deployment_strategy_convertToJSON(v1beta2_deployment_strategy_t *v1beta2_deployment_strategy) {
	...
	// v1beta2_deployment_strategy->rollingUpdate
    if(v1beta2_deployment_strategy->rollingUpdate) { 
    cJSON *rollingUpdate_local_JSON = v1beta2_rolling_update_deployment_convertToJSON(v1beta2_deployment_strategy->rollingUpdate);
...
v1beta2_deployment_strategy_t *v1beta2_deployment_strategy_parseFromJSON(cJSON *v1beta2_deployment_strategyJSON){
    ...
    // v1beta2_deployment_strategy->rollingUpdate
    cJSON *rollingUpdate = cJSON_GetObjectItemCaseSensitive(v1beta2_deployment_strategyJSON, "rollingUpdate");
    v1beta2_rolling_update_deployment_t *rollingUpdate_local_nonprim = NULL;
    if (rollingUpdate) { 
    rollingUpdate_local_nonprim = v1beta2_rolling_update_deployment_parseFromJSON(rollingUpdate); //nonprimitive
    }
