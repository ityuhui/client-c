...
v1_flex_persistent_volume_source_t *v1_flex_persistent_volume_source_create(
	...
	v1_flex_persistent_volume_source_local_var->fsType = fsType;
	v1_flex_persistent_volume_source_local_var->options = options;
	v1_flex_persistent_volume_source_local_var->readOnly = readOnly;
	v1_flex_persistent_volume_source_local_var->secretRef = secretRef;
...
cJSON *v1_flex_persistent_volume_source_convertToJSON(v1_flex_persistent_volume_source_t *v1_flex_persistent_volume_source) {
	...
	// v1_flex_persistent_volume_source->fsType
    if(v1_flex_persistent_volume_source->fsType) { 
    if(cJSON_AddStringToObject(item, "fsType", v1_flex_persistent_volume_source->fsType) == NULL) {
    goto fail; //String
    }
     } 
	...
	// v1_flex_persistent_volume_source->readOnly
    if(v1_flex_persistent_volume_source->readOnly) { 
    if(cJSON_AddBoolToObject(item, "readOnly", v1_flex_persistent_volume_source->readOnly) == NULL) {
    goto fail; //Bool
    }
     } 


	// v1_flex_persistent_volume_source->secretRef
    if(v1_flex_persistent_volume_source->secretRef) { 
    cJSON *secretRef_local_JSON = v1_secret_reference_convertToJSON(v1_flex_persistent_volume_source->secretRef);
...
v1_flex_persistent_volume_source_t *v1_flex_persistent_volume_source_parseFromJSON(cJSON *v1_flex_persistent_volume_sourceJSON){
    ...
    // v1_flex_persistent_volume_source->fsType
    cJSON *fsType = cJSON_GetObjectItemCaseSensitive(v1_flex_persistent_volume_sourceJSON, "fsType");
    if (fsType) { 
    ...
    // v1_flex_persistent_volume_source->readOnly
    cJSON *readOnly = cJSON_GetObjectItemCaseSensitive(v1_flex_persistent_volume_sourceJSON, "readOnly");
    if (readOnly) { 
    ...
    // v1_flex_persistent_volume_source->secretRef
    cJSON *secretRef = cJSON_GetObjectItemCaseSensitive(v1_flex_persistent_volume_sourceJSON, "secretRef");
