...
v1alpha1_cluster_role_list_t *v1alpha1_cluster_role_list_create(
	...
	v1alpha1_cluster_role_list_local_var->apiVersion = apiVersion;
...
void v1alpha1_cluster_role_list_free(v1alpha1_cluster_role_list_t *v1alpha1_cluster_role_list) {
    ...
    free(v1alpha1_cluster_role_list->apiVersion);
...
cJSON *v1alpha1_cluster_role_list_convertToJSON(v1alpha1_cluster_role_list_t *v1alpha1_cluster_role_list) {
	...
	// v1alpha1_cluster_role_list->apiVersion
    if(v1alpha1_cluster_role_list->apiVersion) { 
    if(cJSON_AddStringToObject(item, "apiVersion", v1alpha1_cluster_role_list->apiVersion) == NULL) {
    goto fail; //String
    }
     } 
...
v1alpha1_cluster_role_list_t *v1alpha1_cluster_role_list_parseFromJSON(cJSON *v1alpha1_cluster_role_listJSON){
    ...
    // v1alpha1_cluster_role_list->apiVersion
    cJSON *apiVersion = cJSON_GetObjectItemCaseSensitive(v1alpha1_cluster_role_listJSON, "apiVersion");
    if (apiVersion) { 
