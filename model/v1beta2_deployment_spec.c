...
v1beta2_deployment_spec_t *v1beta2_deployment_spec_create(
	...
	v1beta2_deployment_spec_local_var->minReadySeconds = minReadySeconds;
	v1beta2_deployment_spec_local_var->paused = paused;
	v1beta2_deployment_spec_local_var->progressDeadlineSeconds = progressDeadlineSeconds;
	v1beta2_deployment_spec_local_var->replicas = replicas;
	v1beta2_deployment_spec_local_var->revisionHistoryLimit = revisionHistoryLimit;
...
cJSON *v1beta2_deployment_spec_convertToJSON(v1beta2_deployment_spec_t *v1beta2_deployment_spec) {
	...
	// v1beta2_deployment_spec->minReadySeconds
    if(v1beta2_deployment_spec->minReadySeconds) { 
    if(cJSON_AddNumberToObject(item, "minReadySeconds", v1beta2_deployment_spec->minReadySeconds) == NULL) {
    goto fail; //Numeric
    }
     } 
	...
	// v1beta2_deployment_spec->progressDeadlineSeconds
    if(v1beta2_deployment_spec->progressDeadlineSeconds) { 
    if(cJSON_AddNumberToObject(item, "progressDeadlineSeconds", v1beta2_deployment_spec->progressDeadlineSeconds) == NULL) {
    goto fail; //Numeric
    }
     } 
	...
	// v1beta2_deployment_spec->revisionHistoryLimit
    if(v1beta2_deployment_spec->revisionHistoryLimit) { 
    if(cJSON_AddNumberToObject(item, "revisionHistoryLimit", v1beta2_deployment_spec->revisionHistoryLimit) == NULL) {
    goto fail; //Numeric
    }
     } 
...
v1beta2_deployment_spec_t *v1beta2_deployment_spec_parseFromJSON(cJSON *v1beta2_deployment_specJSON){
    ...
    // v1beta2_deployment_spec->minReadySeconds
    cJSON *minReadySeconds = cJSON_GetObjectItemCaseSensitive(v1beta2_deployment_specJSON, "minReadySeconds");
    if (minReadySeconds) { 
    ...
    // v1beta2_deployment_spec->progressDeadlineSeconds
    cJSON *progressDeadlineSeconds = cJSON_GetObjectItemCaseSensitive(v1beta2_deployment_specJSON, "progressDeadlineSeconds");
    ...
    // v1beta2_deployment_spec->revisionHistoryLimit
    cJSON *revisionHistoryLimit = cJSON_GetObjectItemCaseSensitive(v1beta2_deployment_specJSON, "revisionHistoryLimit");
