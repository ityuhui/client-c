...
v1_rolling_update_deployment_t *v1_rolling_update_deployment_create(
	...
	v1_rolling_update_deployment_local_var->maxSurge = maxSurge;
	v1_rolling_update_deployment_local_var->maxUnavailable = maxUnavailable;
...
void v1_rolling_update_deployment_free(v1_rolling_update_deployment_t *v1_rolling_update_deployment) {
    ...
    object_free(v1_rolling_update_deployment->maxSurge);
    object_free(v1_rolling_update_deployment->maxUnavailable);
...
cJSON *v1_rolling_update_deployment_convertToJSON(v1_rolling_update_deployment_t *v1_rolling_update_deployment) {
	...
	// v1_rolling_update_deployment->maxSurge
    if(v1_rolling_update_deployment->maxSurge) { 
    cJSON *maxSurge_object = object_convertToJSON(v1_rolling_update_deployment->maxSurge);
	...
	// v1_rolling_update_deployment->maxUnavailable
    if(v1_rolling_update_deployment->maxUnavailable) { 
    cJSON *maxUnavailable_object = object_convertToJSON(v1_rolling_update_deployment->maxUnavailable);
...
v1_rolling_update_deployment_t *v1_rolling_update_deployment_parseFromJSON(cJSON *v1_rolling_update_deploymentJSON){
    ...
    // v1_rolling_update_deployment->maxSurge
    cJSON *maxSurge = cJSON_GetObjectItemCaseSensitive(v1_rolling_update_deploymentJSON, "maxSurge");
    ...
    // v1_rolling_update_deployment->maxUnavailable
    cJSON *maxUnavailable = cJSON_GetObjectItemCaseSensitive(v1_rolling_update_deploymentJSON, "maxUnavailable");
