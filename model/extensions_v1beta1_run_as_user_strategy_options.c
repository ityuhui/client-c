...
extensions_v1beta1_run_as_user_strategy_options_t *extensions_v1beta1_run_as_user_strategy_options_create(
	...
	extensions_v1beta1_run_as_user_strategy_options_t *extensions_v1beta1_run_as_user_strategy_options_local_var = malloc(sizeof(extensions_v1beta1_run_as_user_strategy_options_t));
    if (!extensions_v1beta1_run_as_user_strategy_options_local_var) {
        return NULL;
    }
	extensions_v1beta1_run_as_user_strategy_options_local_var->ranges = ranges;
	extensions_v1beta1_run_as_user_strategy_options_local_var->rule = rule;

	return extensions_v1beta1_run_as_user_strategy_options_local_var;
}
...
cJSON *extensions_v1beta1_run_as_user_strategy_options_convertToJSON(extensions_v1beta1_run_as_user_strategy_options_t *extensions_v1beta1_run_as_user_strategy_options) {
	...
	// extensions_v1beta1_run_as_user_strategy_options->ranges
    ...
    if (extensions_v1beta1_run_as_user_strategy_options->ranges) {
    list_ForEach(rangesListEntry, extensions_v1beta1_run_as_user_strategy_options->ranges) {
	...
	// extensions_v1beta1_run_as_user_strategy_options->rule
    if (!extensions_v1beta1_run_as_user_strategy_options->rule) {
        goto fail;
    }
    
    if(cJSON_AddStringToObject(item, "rule", extensions_v1beta1_run_as_user_strategy_options->rule) == NULL) {
    goto fail; //String
    }
...
extensions_v1beta1_run_as_user_strategy_options_t *extensions_v1beta1_run_as_user_strategy_options_parseFromJSON(cJSON *extensions_v1beta1_run_as_user_strategy_optionsJSON){
    ...
    extensions_v1beta1_run_as_user_strategy_options_t *extensions_v1beta1_run_as_user_strategy_options_local_var = NULL;

    // extensions_v1beta1_run_as_user_strategy_options->ranges
    cJSON *ranges = cJSON_GetObjectItemCaseSensitive(extensions_v1beta1_run_as_user_strategy_optionsJSON, "ranges");
    list_t *rangesList;
    if (ranges) { 
    ...
    // extensions_v1beta1_run_as_user_strategy_options->rule
    cJSON *rule = cJSON_GetObjectItemCaseSensitive(extensions_v1beta1_run_as_user_strategy_optionsJSON, "rule");
    if (!rule) {
        goto end;
    }
    ...
    extensions_v1beta1_run_as_user_strategy_options_local_var = extensions_v1beta1_run_as_user_strategy_options_create (
