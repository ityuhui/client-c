...
v1_ceph_fs_persistent_volume_source_t *v1_ceph_fs_persistent_volume_source_create(
	...
	v1_ceph_fs_persistent_volume_source_local_var->readOnly = readOnly;
	v1_ceph_fs_persistent_volume_source_local_var->secretFile = secretFile;
	v1_ceph_fs_persistent_volume_source_local_var->secretRef = secretRef;
...
void v1_ceph_fs_persistent_volume_source_free(v1_ceph_fs_persistent_volume_source_t *v1_ceph_fs_persistent_volume_source) {
    ...
    free(v1_ceph_fs_persistent_volume_source->secretFile);
    v1_secret_reference_free(v1_ceph_fs_persistent_volume_source->secretRef);
...
cJSON *v1_ceph_fs_persistent_volume_source_convertToJSON(v1_ceph_fs_persistent_volume_source_t *v1_ceph_fs_persistent_volume_source) {
	...
	// v1_ceph_fs_persistent_volume_source->readOnly
    if(v1_ceph_fs_persistent_volume_source->readOnly) { 
    if(cJSON_AddBoolToObject(item, "readOnly", v1_ceph_fs_persistent_volume_source->readOnly) == NULL) {
    goto fail; //Bool
    }
     } 


	// v1_ceph_fs_persistent_volume_source->secretFile
    if(v1_ceph_fs_persistent_volume_source->secretFile) { 
    if(cJSON_AddStringToObject(item, "secretFile", v1_ceph_fs_persistent_volume_source->secretFile) == NULL) {
    goto fail; //String
    }
     } 


	// v1_ceph_fs_persistent_volume_source->secretRef
    if(v1_ceph_fs_persistent_volume_source->secretRef) { 
    cJSON *secretRef_local_JSON = v1_secret_reference_convertToJSON(v1_ceph_fs_persistent_volume_source->secretRef);
...
v1_ceph_fs_persistent_volume_source_t *v1_ceph_fs_persistent_volume_source_parseFromJSON(cJSON *v1_ceph_fs_persistent_volume_sourceJSON){
    ...
    // v1_ceph_fs_persistent_volume_source->readOnly
    cJSON *readOnly = cJSON_GetObjectItemCaseSensitive(v1_ceph_fs_persistent_volume_sourceJSON, "readOnly");
    if (readOnly) { 
    ...
    // v1_ceph_fs_persistent_volume_source->secretFile
    cJSON *secretFile = cJSON_GetObjectItemCaseSensitive(v1_ceph_fs_persistent_volume_sourceJSON, "secretFile");
    if (secretFile) { 
    ...
    // v1_ceph_fs_persistent_volume_source->secretRef
    cJSON *secretRef = cJSON_GetObjectItemCaseSensitive(v1_ceph_fs_persistent_volume_sourceJSON, "secretRef");
