...
typedef struct v2beta2_metric_status_t {
    v2beta2_external_metric_status_t *external; //model
    v2beta2_object_metric_status_t *object; //model
    v2beta2_pods_metric_status_t *pods; //model
    v2beta2_resource_metric_status_t *resource; //model
    char *type; // string
