/*
 * admissionregistration_v1beta1_webhook_client_config.h
 *
 * WebhookClientConfig contains the information to make a TLS connection with the webhook
 */

#ifndef _admissionregistration_v1beta1_webhook_client_config_H_
#define _admissionregistration_v1beta1_webhook_client_config_H_
...
typedef struct admissionregistration_v1beta1_webhook_client_config_t {
    char caBundle; //Byte
    admissionregistration_v1beta1_service_reference_t *service; //model
    char *url; // string
...
#endif /* _admissionregistration_v1beta1_webhook_client_config_H_ */
