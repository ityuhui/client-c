...
typedef struct extensions_v1beta1_pod_security_policy_spec_t {
    ...
    extensions_v1beta1_fs_group_strategy_options_t *fsGroup; //model
    int hostIPC; //boolean
    ...
    extensions_v1beta1_run_as_group_strategy_options_t *runAsGroup; //model
    extensions_v1beta1_run_as_user_strategy_options_t *runAsUser; //model
    extensions_v1beta1_runtime_class_strategy_options_t *runtimeClass; //model
    extensions_v1beta1_se_linux_strategy_options_t *seLinux; //model
    extensions_v1beta1_supplemental_groups_strategy_options_t *supplementalGroups; //model
