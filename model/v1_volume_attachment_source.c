...
v1_volume_attachment_source_t *v1_volume_attachment_source_create(
	...
	v1_volume_attachment_source_local_var->inlineVolumeSpec = inlineVolumeSpec;
	v1_volume_attachment_source_local_var->persistentVolumeName = persistentVolumeName;
...
void v1_volume_attachment_source_free(v1_volume_attachment_source_t *v1_volume_attachment_source) {
    ...
    v1_persistent_volume_spec_free(v1_volume_attachment_source->inlineVolumeSpec);
    free(v1_volume_attachment_source->persistentVolumeName);
...
cJSON *v1_volume_attachment_source_convertToJSON(v1_volume_attachment_source_t *v1_volume_attachment_source) {
	...
	// v1_volume_attachment_source->inlineVolumeSpec
    if(v1_volume_attachment_source->inlineVolumeSpec) { 
    cJSON *inlineVolumeSpec_local_JSON = v1_persistent_volume_spec_convertToJSON(v1_volume_attachment_source->inlineVolumeSpec);
	...
	// v1_volume_attachment_source->persistentVolumeName
    if(v1_volume_attachment_source->persistentVolumeName) { 
    if(cJSON_AddStringToObject(item, "persistentVolumeName", v1_volume_attachment_source->persistentVolumeName) == NULL) {
    goto fail; //String
    }
     } 
...
v1_volume_attachment_source_t *v1_volume_attachment_source_parseFromJSON(cJSON *v1_volume_attachment_sourceJSON){
    ...
    // v1_volume_attachment_source->inlineVolumeSpec
    cJSON *inlineVolumeSpec = cJSON_GetObjectItemCaseSensitive(v1_volume_attachment_sourceJSON, "inlineVolumeSpec");
    ...
    // v1_volume_attachment_source->persistentVolumeName
    cJSON *persistentVolumeName = cJSON_GetObjectItemCaseSensitive(v1_volume_attachment_sourceJSON, "persistentVolumeName");
