...
v1alpha1_role_binding_list_t *v1alpha1_role_binding_list_create(
	...
	v1alpha1_role_binding_list_local_var->apiVersion = apiVersion;
...
void v1alpha1_role_binding_list_free(v1alpha1_role_binding_list_t *v1alpha1_role_binding_list) {
    ...
    free(v1alpha1_role_binding_list->apiVersion);
...
cJSON *v1alpha1_role_binding_list_convertToJSON(v1alpha1_role_binding_list_t *v1alpha1_role_binding_list) {
	...
	// v1alpha1_role_binding_list->apiVersion
    if(v1alpha1_role_binding_list->apiVersion) { 
    if(cJSON_AddStringToObject(item, "apiVersion", v1alpha1_role_binding_list->apiVersion) == NULL) {
    goto fail; //String
    }
     } 
...
v1alpha1_role_binding_list_t *v1alpha1_role_binding_list_parseFromJSON(cJSON *v1alpha1_role_binding_listJSON){
    ...
    // v1alpha1_role_binding_list->apiVersion
    cJSON *apiVersion = cJSON_GetObjectItemCaseSensitive(v1alpha1_role_binding_listJSON, "apiVersion");
    if (apiVersion) { 
