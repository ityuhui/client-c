...
v1_resource_attributes_t *v1_resource_attributes_create(
	...
	v1_resource_attributes_local_var->namespace = namespace;
...
void v1_resource_attributes_free(v1_resource_attributes_t *v1_resource_attributes) {
    ...
    free(v1_resource_attributes->namespace);
...
cJSON *v1_resource_attributes_convertToJSON(v1_resource_attributes_t *v1_resource_attributes) {
	...
	// v1_resource_attributes->namespace
    if(v1_resource_attributes->namespace) { 
    if(cJSON_AddStringToObject(item, "namespace", v1_resource_attributes->namespace) == NULL) {
    goto fail; //String
    }
     } 
...
v1_resource_attributes_t *v1_resource_attributes_parseFromJSON(cJSON *v1_resource_attributesJSON){
    ...
    // v1_resource_attributes->namespace
    cJSON *namespace = cJSON_GetObjectItemCaseSensitive(v1_resource_attributesJSON, "namespace");
    if (namespace) { 
