...
v2beta2_object_metric_source_t *v2beta2_object_metric_source_create(
    v2beta2_cross_version_object_reference_t *describedObject,
	...
	v2beta2_object_metric_source_local_var->describedObject = describedObject;
...
void v2beta2_object_metric_source_free(v2beta2_object_metric_source_t *v2beta2_object_metric_source) {
    ...
    v2beta2_cross_version_object_reference_free(v2beta2_object_metric_source->describedObject);
...
cJSON *v2beta2_object_metric_source_convertToJSON(v2beta2_object_metric_source_t *v2beta2_object_metric_source) {
	...
	// v2beta2_object_metric_source->describedObject
    if (!v2beta2_object_metric_source->describedObject) {
        goto fail;
    }
    
    cJSON *describedObject_local_JSON = v2beta2_cross_version_object_reference_convertToJSON(v2beta2_object_metric_source->describedObject);
    if(describedObject_local_JSON == NULL) {
    goto fail; //model
    }
    cJSON_AddItemToObject(item, "describedObject", describedObject_local_JSON);
    if(item->child == NULL) {
    goto fail;
    }
...
v2beta2_object_metric_source_t *v2beta2_object_metric_source_parseFromJSON(cJSON *v2beta2_object_metric_sourceJSON){
    ...
    // v2beta2_object_metric_source->describedObject
    cJSON *describedObject = cJSON_GetObjectItemCaseSensitive(v2beta2_object_metric_sourceJSON, "describedObject");
    if (!describedObject) {
        goto end;
    }

    v2beta2_cross_version_object_reference_t *describedObject_local_nonprim = NULL;
    
    describedObject_local_nonprim = v2beta2_cross_version_object_reference_parseFromJSON(describedObject); //nonprimitive
