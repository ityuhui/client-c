...
v1beta1_cron_job_list_t *v1beta1_cron_job_list_create(
	...
	v1beta1_cron_job_list_local_var->apiVersion = apiVersion;
...
cJSON *v1beta1_cron_job_list_convertToJSON(v1beta1_cron_job_list_t *v1beta1_cron_job_list) {
	...
	// v1beta1_cron_job_list->apiVersion
    if(v1beta1_cron_job_list->apiVersion) { 
    if(cJSON_AddStringToObject(item, "apiVersion", v1beta1_cron_job_list->apiVersion) == NULL) {
    goto fail; //String
    }
     } 
...
v1beta1_cron_job_list_t *v1beta1_cron_job_list_parseFromJSON(cJSON *v1beta1_cron_job_listJSON){
    ...
    // v1beta1_cron_job_list->apiVersion
    cJSON *apiVersion = cJSON_GetObjectItemCaseSensitive(v1beta1_cron_job_listJSON, "apiVersion");
    if (apiVersion) { 
