...
v1alpha1_volume_attachment_status_t *v1alpha1_volume_attachment_status_create(
	...
	v1alpha1_volume_attachment_status_local_var->attachError = attachError;
	v1alpha1_volume_attachment_status_local_var->attached = attached;
	v1alpha1_volume_attachment_status_local_var->attachmentMetadata = attachmentMetadata;
	v1alpha1_volume_attachment_status_local_var->detachError = detachError;
...
void v1alpha1_volume_attachment_status_free(v1alpha1_volume_attachment_status_t *v1alpha1_volume_attachment_status) {
    ...
    v1alpha1_volume_error_free(v1alpha1_volume_attachment_status->attachError);
	list_ForEach(listEntry, v1alpha1_volume_attachment_status->attachmentMetadata) {
		keyValuePair_t *localMapKeyPair = (keyValuePair_t*) listEntry->data;
        free (localKeyValue->key);
        free (localKeyValue->value);
	}
	list_free(v1alpha1_volume_attachment_status->attachmentMetadata);
    v1alpha1_volume_error_free(v1alpha1_volume_attachment_status->detachError);
...
cJSON *v1alpha1_volume_attachment_status_convertToJSON(v1alpha1_volume_attachment_status_t *v1alpha1_volume_attachment_status) {
	...
	// v1alpha1_volume_attachment_status->attachError
    if(v1alpha1_volume_attachment_status->attachError) { 
    cJSON *attachError_local_JSON = v1alpha1_volume_error_convertToJSON(v1alpha1_volume_attachment_status->attachError);
	...
	// v1alpha1_volume_attachment_status->attachmentMetadata
    if(v1alpha1_volume_attachment_status->attachmentMetadata) { 
    ...
    if (v1alpha1_volume_attachment_status->attachmentMetadata) {
    list_ForEach(attachmentMetadataListEntry, v1alpha1_volume_attachment_status->attachmentMetadata) {
	...
	// v1alpha1_volume_attachment_status->detachError
    if(v1alpha1_volume_attachment_status->detachError) { 
    cJSON *detachError_local_JSON = v1alpha1_volume_error_convertToJSON(v1alpha1_volume_attachment_status->detachError);
...
v1alpha1_volume_attachment_status_t *v1alpha1_volume_attachment_status_parseFromJSON(cJSON *v1alpha1_volume_attachment_statusJSON){
    ...
    // v1alpha1_volume_attachment_status->attachError
    cJSON *attachError = cJSON_GetObjectItemCaseSensitive(v1alpha1_volume_attachment_statusJSON, "attachError");
    v1alpha1_volume_error_t *attachError_local_nonprim = NULL;
    if (attachError) { 
    attachError_local_nonprim = v1alpha1_volume_error_parseFromJSON(attachError); //nonprimitive
    }
    ...
    // v1alpha1_volume_attachment_status->attachmentMetadata
    cJSON *attachmentMetadata = cJSON_GetObjectItemCaseSensitive(v1alpha1_volume_attachment_statusJSON, "attachmentMetadata");
    list_t *List;
    ...
    // v1alpha1_volume_attachment_status->detachError
    cJSON *detachError = cJSON_GetObjectItemCaseSensitive(v1alpha1_volume_attachment_statusJSON, "detachError");
    v1alpha1_volume_error_t *detachError_local_nonprim = NULL;
    if (detachError) { 
    detachError_local_nonprim = v1alpha1_volume_error_parseFromJSON(detachError); //nonprimitive
    }
