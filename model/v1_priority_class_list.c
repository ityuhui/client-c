...
v1_priority_class_list_t *v1_priority_class_list_create(
	...
	v1_priority_class_list_local_var->apiVersion = apiVersion;
...
cJSON *v1_priority_class_list_convertToJSON(v1_priority_class_list_t *v1_priority_class_list) {
	...
	// v1_priority_class_list->apiVersion
    if(v1_priority_class_list->apiVersion) { 
    if(cJSON_AddStringToObject(item, "apiVersion", v1_priority_class_list->apiVersion) == NULL) {
    goto fail; //String
    }
     } 
...
v1_priority_class_list_t *v1_priority_class_list_parseFromJSON(cJSON *v1_priority_class_listJSON){
    ...
    // v1_priority_class_list->apiVersion
    cJSON *apiVersion = cJSON_GetObjectItemCaseSensitive(v1_priority_class_listJSON, "apiVersion");
    if (apiVersion) { 
