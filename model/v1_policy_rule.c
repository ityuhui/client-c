...
v1_policy_rule_t *v1_policy_rule_create(
	...
	v1_policy_rule_local_var->apiGroups = apiGroups;
	v1_policy_rule_local_var->nonResourceURLs = nonResourceURLs;
	v1_policy_rule_local_var->resourceNames = resourceNames;
...
void v1_policy_rule_free(v1_policy_rule_t *v1_policy_rule) {
	...
	list_ForEach(listEntry, v1_policy_rule->apiGroups) {
		free(listEntry->data);
	}
	list_free(v1_policy_rule->apiGroups);
	list_ForEach(listEntry, v1_policy_rule->nonResourceURLs) {
		free(listEntry->data);
	}
	list_free(v1_policy_rule->nonResourceURLs);
	list_ForEach(listEntry, v1_policy_rule->resourceNames) {
		free(listEntry->data);
	}
	list_free(v1_policy_rule->resourceNames);
...
cJSON *v1_policy_rule_convertToJSON(v1_policy_rule_t *v1_policy_rule) {
	...
	// v1_policy_rule->apiGroups
    if(v1_policy_rule->apiGroups) { 
    ...
    list_ForEach(api_groupsListEntry, v1_policy_rule->apiGroups) {
	...
	// v1_policy_rule->nonResourceURLs
    if(v1_policy_rule->nonResourceURLs) { 
    ...
    list_ForEach(non_resource_ur_lsListEntry, v1_policy_rule->nonResourceURLs) {
	...
	// v1_policy_rule->resourceNames
    if(v1_policy_rule->resourceNames) { 
    ...
    list_ForEach(resource_namesListEntry, v1_policy_rule->resourceNames) {
...
v1_policy_rule_t *v1_policy_rule_parseFromJSON(cJSON *v1_policy_ruleJSON){
    ...
    // v1_policy_rule->apiGroups
    cJSON *apiGroups = cJSON_GetObjectItemCaseSensitive(v1_policy_ruleJSON, "apiGroups");
    ...
    // v1_policy_rule->nonResourceURLs
    cJSON *nonResourceURLs = cJSON_GetObjectItemCaseSensitive(v1_policy_ruleJSON, "nonResourceURLs");
    ...
    // v1_policy_rule->resourceNames
    cJSON *resourceNames = cJSON_GetObjectItemCaseSensitive(v1_policy_ruleJSON, "resourceNames");
