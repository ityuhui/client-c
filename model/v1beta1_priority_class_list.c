...
v1beta1_priority_class_list_t *v1beta1_priority_class_list_create(
	...
	v1beta1_priority_class_list_local_var->apiVersion = apiVersion;
...
void v1beta1_priority_class_list_free(v1beta1_priority_class_list_t *v1beta1_priority_class_list) {
    ...
    free(v1beta1_priority_class_list->apiVersion);
...
cJSON *v1beta1_priority_class_list_convertToJSON(v1beta1_priority_class_list_t *v1beta1_priority_class_list) {
	...
	// v1beta1_priority_class_list->apiVersion
    if(v1beta1_priority_class_list->apiVersion) { 
    if(cJSON_AddStringToObject(item, "apiVersion", v1beta1_priority_class_list->apiVersion) == NULL) {
    goto fail; //String
    }
     } 
...
v1beta1_priority_class_list_t *v1beta1_priority_class_list_parseFromJSON(cJSON *v1beta1_priority_class_listJSON){
    ...
    // v1beta1_priority_class_list->apiVersion
    cJSON *apiVersion = cJSON_GetObjectItemCaseSensitive(v1beta1_priority_class_listJSON, "apiVersion");
    if (apiVersion) { 
