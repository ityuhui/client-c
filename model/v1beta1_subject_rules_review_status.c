...
v1beta1_subject_rules_review_status_t *v1beta1_subject_rules_review_status_create(
	...
	v1beta1_subject_rules_review_status_local_var->evaluationError = evaluationError;
	v1beta1_subject_rules_review_status_local_var->incomplete = incomplete;
	v1beta1_subject_rules_review_status_local_var->nonResourceRules = nonResourceRules;
	v1beta1_subject_rules_review_status_local_var->resourceRules = resourceRules;
...
void v1beta1_subject_rules_review_status_free(v1beta1_subject_rules_review_status_t *v1beta1_subject_rules_review_status) {
    ...
    free(v1beta1_subject_rules_review_status->evaluationError);
	list_ForEach(listEntry, v1beta1_subject_rules_review_status->nonResourceRules) {
		v1beta1_non_resource_rule_free(listEntry->data);
	}
	list_free(v1beta1_subject_rules_review_status->nonResourceRules);
	list_ForEach(listEntry, v1beta1_subject_rules_review_status->resourceRules) {
		v1beta1_resource_rule_free(listEntry->data);
	}
	list_free(v1beta1_subject_rules_review_status->resourceRules);
...
cJSON *v1beta1_subject_rules_review_status_convertToJSON(v1beta1_subject_rules_review_status_t *v1beta1_subject_rules_review_status) {
	...
	// v1beta1_subject_rules_review_status->evaluationError
    if(v1beta1_subject_rules_review_status->evaluationError) { 
    if(cJSON_AddStringToObject(item, "evaluationError", v1beta1_subject_rules_review_status->evaluationError) == NULL) {
    goto fail; //String
    }
     } 
	...
	// v1beta1_subject_rules_review_status->nonResourceRules
    if (!v1beta1_subject_rules_review_status->nonResourceRules) {
        goto fail;
    }
    ...
    if (v1beta1_subject_rules_review_status->nonResourceRules) {
    list_ForEach(nonResourceRulesListEntry, v1beta1_subject_rules_review_status->nonResourceRules) {
    cJSON *itemLocal = v1beta1_non_resource_rule_convertToJSON(nonResourceRulesListEntry->data);
    if(itemLocal == NULL) {
    goto fail;
    }
	...
	// v1beta1_subject_rules_review_status->resourceRules
    if (!v1beta1_subject_rules_review_status->resourceRules) {
        goto fail;
    }
    ...
    if (v1beta1_subject_rules_review_status->resourceRules) {
    list_ForEach(resourceRulesListEntry, v1beta1_subject_rules_review_status->resourceRules) {
    cJSON *itemLocal = v1beta1_resource_rule_convertToJSON(resourceRulesListEntry->data);
    if(itemLocal == NULL) {
    goto fail;
    }
...
v1beta1_subject_rules_review_status_t *v1beta1_subject_rules_review_status_parseFromJSON(cJSON *v1beta1_subject_rules_review_statusJSON){
    ...
    // v1beta1_subject_rules_review_status->evaluationError
    cJSON *evaluationError = cJSON_GetObjectItemCaseSensitive(v1beta1_subject_rules_review_statusJSON, "evaluationError");
    if (evaluationError) { 
    ...
    // v1beta1_subject_rules_review_status->nonResourceRules
    cJSON *nonResourceRules = cJSON_GetObjectItemCaseSensitive(v1beta1_subject_rules_review_statusJSON, "nonResourceRules");
    if (!nonResourceRules) {
        goto end;
    }
    ...
    cJSON_ArrayForEach(nonResourceRules_local_nonprimitive,nonResourceRules )
    {
        ...
        v1beta1_non_resource_rule_t *nonResourceRulesItem = v1beta1_non_resource_rule_parseFromJSON(nonResourceRules_local_nonprimitive);

        list_addElement(nonResourceRulesList, nonResourceRulesItem);
    }

    // v1beta1_subject_rules_review_status->resourceRules
    cJSON *resourceRules = cJSON_GetObjectItemCaseSensitive(v1beta1_subject_rules_review_statusJSON, "resourceRules");
    if (!resourceRules) {
        goto end;
    }
    ...
    cJSON_ArrayForEach(resourceRules_local_nonprimitive,resourceRules )
    {
        ...
        v1beta1_resource_rule_t *resourceRulesItem = v1beta1_resource_rule_parseFromJSON(resourceRules_local_nonprimitive);
