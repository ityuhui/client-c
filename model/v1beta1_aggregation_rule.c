...
v1beta1_aggregation_rule_t *v1beta1_aggregation_rule_create(
	...
	v1beta1_aggregation_rule_t *v1beta1_aggregation_rule_local_var = malloc(sizeof(v1beta1_aggregation_rule_t));
    if (!v1beta1_aggregation_rule_local_var) {
        return NULL;
    }
	v1beta1_aggregation_rule_local_var->clusterRoleSelectors = clusterRoleSelectors;

	return v1beta1_aggregation_rule_local_var;
}


void v1beta1_aggregation_rule_free(v1beta1_aggregation_rule_t *v1beta1_aggregation_rule) {
    listEntry_t *listEntry;
	list_ForEach(listEntry, v1beta1_aggregation_rule->clusterRoleSelectors) {
		v1_label_selector_free(listEntry->data);
	}
	list_free(v1beta1_aggregation_rule->clusterRoleSelectors);
	free(v1beta1_aggregation_rule);
}

cJSON *v1beta1_aggregation_rule_convertToJSON(v1beta1_aggregation_rule_t *v1beta1_aggregation_rule) {
	cJSON *item = cJSON_CreateObject();

	// v1beta1_aggregation_rule->clusterRoleSelectors
    if(v1beta1_aggregation_rule->clusterRoleSelectors) { 
    ...
    if (v1beta1_aggregation_rule->clusterRoleSelectors) {
    list_ForEach(clusterRoleSelectorsListEntry, v1beta1_aggregation_rule->clusterRoleSelectors) {
...
v1beta1_aggregation_rule_t *v1beta1_aggregation_rule_parseFromJSON(cJSON *v1beta1_aggregation_ruleJSON){
    ...
    v1beta1_aggregation_rule_t *v1beta1_aggregation_rule_local_var = NULL;

    // v1beta1_aggregation_rule->clusterRoleSelectors
    cJSON *clusterRoleSelectors = cJSON_GetObjectItemCaseSensitive(v1beta1_aggregation_ruleJSON, "clusterRoleSelectors");
    ...
    v1beta1_aggregation_rule_local_var = v1beta1_aggregation_rule_create (
