...
v1beta1_storage_class_t *v1beta1_storage_class_create(
	...
	v1beta1_storage_class_local_var->allowVolumeExpansion = allowVolumeExpansion;
	v1beta1_storage_class_local_var->allowedTopologies = allowedTopologies;
	v1beta1_storage_class_local_var->apiVersion = apiVersion;
	v1beta1_storage_class_local_var->kind = kind;
	v1beta1_storage_class_local_var->metadata = metadata;
	v1beta1_storage_class_local_var->mountOptions = mountOptions;
	v1beta1_storage_class_local_var->parameters = parameters;
	v1beta1_storage_class_local_var->provisioner = provisioner;
	v1beta1_storage_class_local_var->reclaimPolicy = reclaimPolicy;
	v1beta1_storage_class_local_var->volumeBindingMode = volumeBindingMode;
...
void v1beta1_storage_class_free(v1beta1_storage_class_t *v1beta1_storage_class) {
	...
	list_ForEach(listEntry, v1beta1_storage_class->allowedTopologies) {
		v1_topology_selector_term_free(listEntry->data);
	}
	list_free(v1beta1_storage_class->allowedTopologies);
    free(v1beta1_storage_class->apiVersion);
    free(v1beta1_storage_class->kind);
    v1_object_meta_free(v1beta1_storage_class->metadata);
	list_ForEach(listEntry, v1beta1_storage_class->mountOptions) {
		free(listEntry->data);
	}
    ...
    free(v1beta1_storage_class->reclaimPolicy);
    free(v1beta1_storage_class->volumeBindingMode);
...
cJSON *v1beta1_storage_class_convertToJSON(v1beta1_storage_class_t *v1beta1_storage_class) {
	...
	// v1beta1_storage_class->allowVolumeExpansion
    if(v1beta1_storage_class->allowVolumeExpansion) { 
    if(cJSON_AddBoolToObject(item, "allowVolumeExpansion", v1beta1_storage_class->allowVolumeExpansion) == NULL) {
    goto fail; //Bool
    }
     } 


	// v1beta1_storage_class->allowedTopologies
    if(v1beta1_storage_class->allowedTopologies) { 
    ...
    if (v1beta1_storage_class->allowedTopologies) {
    list_ForEach(allowedTopologiesListEntry, v1beta1_storage_class->allowedTopologies) {
	...
	// v1beta1_storage_class->apiVersion
    if(v1beta1_storage_class->apiVersion) { 
    if(cJSON_AddStringToObject(item, "apiVersion", v1beta1_storage_class->apiVersion) == NULL) {
    goto fail; //String
    }
     } 
	...
	// v1beta1_storage_class->mountOptions
    if(v1beta1_storage_class->mountOptions) { 
    ...
    list_ForEach(mount_optionsListEntry, v1beta1_storage_class->mountOptions) {
	...
	// v1beta1_storage_class->reclaimPolicy
    if(v1beta1_storage_class->reclaimPolicy) { 
    if(cJSON_AddStringToObject(item, "reclaimPolicy", v1beta1_storage_class->reclaimPolicy) == NULL) {
    goto fail; //String
    }
     } 


	// v1beta1_storage_class->volumeBindingMode
    if(v1beta1_storage_class->volumeBindingMode) { 
    if(cJSON_AddStringToObject(item, "volumeBindingMode", v1beta1_storage_class->volumeBindingMode) == NULL) {
    goto fail; //String
    }
     } 
...
v1beta1_storage_class_t *v1beta1_storage_class_parseFromJSON(cJSON *v1beta1_storage_classJSON){
    ...
    // v1beta1_storage_class->allowVolumeExpansion
    cJSON *allowVolumeExpansion = cJSON_GetObjectItemCaseSensitive(v1beta1_storage_classJSON, "allowVolumeExpansion");
    ...
    // v1beta1_storage_class->allowedTopologies
    cJSON *allowedTopologies = cJSON_GetObjectItemCaseSensitive(v1beta1_storage_classJSON, "allowedTopologies");
    ...
    // v1beta1_storage_class->apiVersion
    cJSON *apiVersion = cJSON_GetObjectItemCaseSensitive(v1beta1_storage_classJSON, "apiVersion");
    if (apiVersion) { 
    ...
    // v1beta1_storage_class->mountOptions
    cJSON *mountOptions = cJSON_GetObjectItemCaseSensitive(v1beta1_storage_classJSON, "mountOptions");
    ...
    // v1beta1_storage_class->reclaimPolicy
    cJSON *reclaimPolicy = cJSON_GetObjectItemCaseSensitive(v1beta1_storage_classJSON, "reclaimPolicy");
    if (reclaimPolicy) { 
    ...
    // v1beta1_storage_class->volumeBindingMode
    cJSON *volumeBindingMode = cJSON_GetObjectItemCaseSensitive(v1beta1_storage_classJSON, "volumeBindingMode");
