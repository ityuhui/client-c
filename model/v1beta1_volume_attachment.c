...
v1beta1_volume_attachment_t *v1beta1_volume_attachment_create(
	...
	v1beta1_volume_attachment_local_var->apiVersion = apiVersion;
...
void v1beta1_volume_attachment_free(v1beta1_volume_attachment_t *v1beta1_volume_attachment) {
    ...
    free(v1beta1_volume_attachment->apiVersion);
...
cJSON *v1beta1_volume_attachment_convertToJSON(v1beta1_volume_attachment_t *v1beta1_volume_attachment) {
	...
	// v1beta1_volume_attachment->apiVersion
    if(v1beta1_volume_attachment->apiVersion) { 
    if(cJSON_AddStringToObject(item, "apiVersion", v1beta1_volume_attachment->apiVersion) == NULL) {
    goto fail; //String
    }
     } 
...
v1beta1_volume_attachment_t *v1beta1_volume_attachment_parseFromJSON(cJSON *v1beta1_volume_attachmentJSON){
    ...
    // v1beta1_volume_attachment->apiVersion
    cJSON *apiVersion = cJSON_GetObjectItemCaseSensitive(v1beta1_volume_attachmentJSON, "apiVersion");
    if (apiVersion) { 
