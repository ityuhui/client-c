...
v1_aws_elastic_block_store_volume_source_t *v1_aws_elastic_block_store_volume_source_create(
	...
	v1_aws_elastic_block_store_volume_source_local_var->fsType = fsType;
	v1_aws_elastic_block_store_volume_source_local_var->partition = partition;
	v1_aws_elastic_block_store_volume_source_local_var->readOnly = readOnly;
	v1_aws_elastic_block_store_volume_source_local_var->volumeID = volumeID;
...
void v1_aws_elastic_block_store_volume_source_free(v1_aws_elastic_block_store_volume_source_t *v1_aws_elastic_block_store_volume_source) {
    ...
    free(v1_aws_elastic_block_store_volume_source->fsType);
    free(v1_aws_elastic_block_store_volume_source->volumeID);
...
cJSON *v1_aws_elastic_block_store_volume_source_convertToJSON(v1_aws_elastic_block_store_volume_source_t *v1_aws_elastic_block_store_volume_source) {
	...
	// v1_aws_elastic_block_store_volume_source->fsType
    if(v1_aws_elastic_block_store_volume_source->fsType) { 
    if(cJSON_AddStringToObject(item, "fsType", v1_aws_elastic_block_store_volume_source->fsType) == NULL) {
    goto fail; //String
    }
     } 
	...
	// v1_aws_elastic_block_store_volume_source->readOnly
    if(v1_aws_elastic_block_store_volume_source->readOnly) { 
    if(cJSON_AddBoolToObject(item, "readOnly", v1_aws_elastic_block_store_volume_source->readOnly) == NULL) {
    goto fail; //Bool
    }
     } 


	// v1_aws_elastic_block_store_volume_source->volumeID
    if (!v1_aws_elastic_block_store_volume_source->volumeID) {
        goto fail;
    }
    
    if(cJSON_AddStringToObject(item, "volumeID", v1_aws_elastic_block_store_volume_source->volumeID) == NULL) {
    goto fail; //String
    }
...
v1_aws_elastic_block_store_volume_source_t *v1_aws_elastic_block_store_volume_source_parseFromJSON(cJSON *v1_aws_elastic_block_store_volume_sourceJSON){
    ...
    // v1_aws_elastic_block_store_volume_source->fsType
    cJSON *fsType = cJSON_GetObjectItemCaseSensitive(v1_aws_elastic_block_store_volume_sourceJSON, "fsType");
    if (fsType) { 
    ...
    // v1_aws_elastic_block_store_volume_source->readOnly
    cJSON *readOnly = cJSON_GetObjectItemCaseSensitive(v1_aws_elastic_block_store_volume_sourceJSON, "readOnly");
    if (readOnly) { 
    ...
    // v1_aws_elastic_block_store_volume_source->volumeID
    cJSON *volumeID = cJSON_GetObjectItemCaseSensitive(v1_aws_elastic_block_store_volume_sourceJSON, "volumeID");
    if (!volumeID) {
        goto end;
    }
