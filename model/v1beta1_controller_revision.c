...
v1beta1_controller_revision_t *v1beta1_controller_revision_create(
	...
	v1beta1_controller_revision_local_var->apiVersion = apiVersion;
...
void v1beta1_controller_revision_free(v1beta1_controller_revision_t *v1beta1_controller_revision) {
    ...
    free(v1beta1_controller_revision->apiVersion);
...
cJSON *v1beta1_controller_revision_convertToJSON(v1beta1_controller_revision_t *v1beta1_controller_revision) {
	...
	// v1beta1_controller_revision->apiVersion
    if(v1beta1_controller_revision->apiVersion) { 
    if(cJSON_AddStringToObject(item, "apiVersion", v1beta1_controller_revision->apiVersion) == NULL) {
    goto fail; //String
    }
     } 
...
v1beta1_controller_revision_t *v1beta1_controller_revision_parseFromJSON(cJSON *v1beta1_controller_revisionJSON){
    ...
    // v1beta1_controller_revision->apiVersion
    cJSON *apiVersion = cJSON_GetObjectItemCaseSensitive(v1beta1_controller_revisionJSON, "apiVersion");
    if (apiVersion) { 
