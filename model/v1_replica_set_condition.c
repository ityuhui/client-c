...
v1_replica_set_condition_t *v1_replica_set_condition_create(
	...
	v1_replica_set_condition_local_var->lastTransitionTime = lastTransitionTime;
...
void v1_replica_set_condition_free(v1_replica_set_condition_t *v1_replica_set_condition) {
    ...
    free(v1_replica_set_condition->lastTransitionTime);
...
cJSON *v1_replica_set_condition_convertToJSON(v1_replica_set_condition_t *v1_replica_set_condition) {
	...
	// v1_replica_set_condition->lastTransitionTime
    if(v1_replica_set_condition->lastTransitionTime) { 
    if(cJSON_AddStringToObject(item, "lastTransitionTime", v1_replica_set_condition->lastTransitionTime) == NULL) {
    goto fail; //Date-Time
    }
     } 
...
v1_replica_set_condition_t *v1_replica_set_condition_parseFromJSON(cJSON *v1_replica_set_conditionJSON){
    ...
    // v1_replica_set_condition->lastTransitionTime
    cJSON *lastTransitionTime = cJSON_GetObjectItemCaseSensitive(v1_replica_set_conditionJSON, "lastTransitionTime");
