...
v1_replication_controller_status_t *v1_replication_controller_status_create(
	...
	v1_replication_controller_status_local_var->availableReplicas = availableReplicas;
	v1_replication_controller_status_local_var->conditions = conditions;
	v1_replication_controller_status_local_var->fullyLabeledReplicas = fullyLabeledReplicas;
	v1_replication_controller_status_local_var->observedGeneration = observedGeneration;
	v1_replication_controller_status_local_var->readyReplicas = readyReplicas;
...
cJSON *v1_replication_controller_status_convertToJSON(v1_replication_controller_status_t *v1_replication_controller_status) {
	...
	// v1_replication_controller_status->availableReplicas
    if(v1_replication_controller_status->availableReplicas) { 
    if(cJSON_AddNumberToObject(item, "availableReplicas", v1_replication_controller_status->availableReplicas) == NULL) {
    goto fail; //Numeric
    }
     } 
	...
	// v1_replication_controller_status->fullyLabeledReplicas
    if(v1_replication_controller_status->fullyLabeledReplicas) { 
    if(cJSON_AddNumberToObject(item, "fullyLabeledReplicas", v1_replication_controller_status->fullyLabeledReplicas) == NULL) {
    goto fail; //Numeric
    }
     } 


	// v1_replication_controller_status->observedGeneration
    if(v1_replication_controller_status->observedGeneration) { 
    if(cJSON_AddNumberToObject(item, "observedGeneration", v1_replication_controller_status->observedGeneration) == NULL) {
    goto fail; //Numeric
    }
     } 


	// v1_replication_controller_status->readyReplicas
    if(v1_replication_controller_status->readyReplicas) { 
    if(cJSON_AddNumberToObject(item, "readyReplicas", v1_replication_controller_status->readyReplicas) == NULL) {
    goto fail; //Numeric
    }
     } 
...
v1_replication_controller_status_t *v1_replication_controller_status_parseFromJSON(cJSON *v1_replication_controller_statusJSON){
    ...
    // v1_replication_controller_status->availableReplicas
    cJSON *availableReplicas = cJSON_GetObjectItemCaseSensitive(v1_replication_controller_statusJSON, "availableReplicas");
    ...
    // v1_replication_controller_status->fullyLabeledReplicas
    cJSON *fullyLabeledReplicas = cJSON_GetObjectItemCaseSensitive(v1_replication_controller_statusJSON, "fullyLabeledReplicas");
    ...
    // v1_replication_controller_status->observedGeneration
    cJSON *observedGeneration = cJSON_GetObjectItemCaseSensitive(v1_replication_controller_statusJSON, "observedGeneration");
    ...
    // v1_replication_controller_status->readyReplicas
    cJSON *readyReplicas = cJSON_GetObjectItemCaseSensitive(v1_replication_controller_statusJSON, "readyReplicas");
    if (readyReplicas) { 
