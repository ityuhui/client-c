...
v1beta1_cluster_role_binding_t *v1beta1_cluster_role_binding_create(
	...
	v1beta1_cluster_role_binding_local_var->apiVersion = apiVersion;
	v1beta1_cluster_role_binding_local_var->kind = kind;
	v1beta1_cluster_role_binding_local_var->metadata = metadata;
	v1beta1_cluster_role_binding_local_var->roleRef = roleRef;
...
void v1beta1_cluster_role_binding_free(v1beta1_cluster_role_binding_t *v1beta1_cluster_role_binding) {
    ...
    free(v1beta1_cluster_role_binding->apiVersion);
    free(v1beta1_cluster_role_binding->kind);
    v1_object_meta_free(v1beta1_cluster_role_binding->metadata);
    v1beta1_role_ref_free(v1beta1_cluster_role_binding->roleRef);
...
cJSON *v1beta1_cluster_role_binding_convertToJSON(v1beta1_cluster_role_binding_t *v1beta1_cluster_role_binding) {
	...
	// v1beta1_cluster_role_binding->apiVersion
    if(v1beta1_cluster_role_binding->apiVersion) { 
    if(cJSON_AddStringToObject(item, "apiVersion", v1beta1_cluster_role_binding->apiVersion) == NULL) {
    goto fail; //String
    }
     } 
	...
	// v1beta1_cluster_role_binding->roleRef
    if (!v1beta1_cluster_role_binding->roleRef) {
        goto fail;
    }
    
    cJSON *roleRef_local_JSON = v1beta1_role_ref_convertToJSON(v1beta1_cluster_role_binding->roleRef);
...
v1beta1_cluster_role_binding_t *v1beta1_cluster_role_binding_parseFromJSON(cJSON *v1beta1_cluster_role_bindingJSON){
    ...
    // v1beta1_cluster_role_binding->apiVersion
    cJSON *apiVersion = cJSON_GetObjectItemCaseSensitive(v1beta1_cluster_role_bindingJSON, "apiVersion");
    if (apiVersion) { 
    ...
    // v1beta1_cluster_role_binding->roleRef
    cJSON *roleRef = cJSON_GetObjectItemCaseSensitive(v1beta1_cluster_role_bindingJSON, "roleRef");
    if (!roleRef) {
        goto end;
    }
