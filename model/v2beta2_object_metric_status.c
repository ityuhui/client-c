...
v2beta2_object_metric_status_t *v2beta2_object_metric_status_create(
	...
	v2beta2_object_metric_status_local_var->describedObject = describedObject;
...
void v2beta2_object_metric_status_free(v2beta2_object_metric_status_t *v2beta2_object_metric_status) {
    ...
    v2beta2_cross_version_object_reference_free(v2beta2_object_metric_status->describedObject);
...
cJSON *v2beta2_object_metric_status_convertToJSON(v2beta2_object_metric_status_t *v2beta2_object_metric_status) {
	...
	// v2beta2_object_metric_status->describedObject
    if (!v2beta2_object_metric_status->describedObject) {
        goto fail;
    }
    
    cJSON *describedObject_local_JSON = v2beta2_cross_version_object_reference_convertToJSON(v2beta2_object_metric_status->describedObject);
...
v2beta2_object_metric_status_t *v2beta2_object_metric_status_parseFromJSON(cJSON *v2beta2_object_metric_statusJSON){
    ...
    // v2beta2_object_metric_status->describedObject
    cJSON *describedObject = cJSON_GetObjectItemCaseSensitive(v2beta2_object_metric_statusJSON, "describedObject");
    if (!describedObject) {
        goto end;
    }
