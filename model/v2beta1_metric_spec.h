...
typedef struct v2beta1_metric_spec_t {
    v2beta1_external_metric_source_t *external; //model
    v2beta1_object_metric_source_t *object; //model
    v2beta1_pods_metric_source_t *pods; //model
    v2beta1_resource_metric_source_t *resource; //model
    char *type; // string
