...
v1_api_service_spec_t *v1_api_service_spec_create(
	...
	v1_api_service_spec_local_var->caBundle = caBundle;
	v1_api_service_spec_local_var->group = group;
	v1_api_service_spec_local_var->groupPriorityMinimum = groupPriorityMinimum;
	v1_api_service_spec_local_var->insecureSkipTLSVerify = insecureSkipTLSVerify;
	v1_api_service_spec_local_var->service = service;
	v1_api_service_spec_local_var->version = version;
	v1_api_service_spec_local_var->versionPriority = versionPriority;
...
cJSON *v1_api_service_spec_convertToJSON(v1_api_service_spec_t *v1_api_service_spec) {
	...
	// v1_api_service_spec->caBundle
    if(v1_api_service_spec->caBundle) { 
    if(cJSON_AddNumberToObject(item, "caBundle", v1_api_service_spec->caBundle) == NULL) {
    goto fail; //Byte
    }
     } 
	...
	// v1_api_service_spec->groupPriorityMinimum
    if (!v1_api_service_spec->groupPriorityMinimum) {
        goto fail;
    }
    
    if(cJSON_AddNumberToObject(item, "groupPriorityMinimum", v1_api_service_spec->groupPriorityMinimum) == NULL) {
    goto fail; //Numeric
    }


	// v1_api_service_spec->insecureSkipTLSVerify
    if(v1_api_service_spec->insecureSkipTLSVerify) { 
    if(cJSON_AddBoolToObject(item, "insecureSkipTLSVerify", v1_api_service_spec->insecureSkipTLSVerify) == NULL) {
    goto fail; //Bool
    }
     } 
	...
	// v1_api_service_spec->versionPriority
    if (!v1_api_service_spec->versionPriority) {
        goto fail;
    }
    
    if(cJSON_AddNumberToObject(item, "versionPriority", v1_api_service_spec->versionPriority) == NULL) {
    goto fail; //Numeric
    }
...
v1_api_service_spec_t *v1_api_service_spec_parseFromJSON(cJSON *v1_api_service_specJSON){
    ...
    // v1_api_service_spec->caBundle
    cJSON *caBundle = cJSON_GetObjectItemCaseSensitive(v1_api_service_specJSON, "caBundle");
    if (caBundle) { 
    ...
    // v1_api_service_spec->groupPriorityMinimum
    cJSON *groupPriorityMinimum = cJSON_GetObjectItemCaseSensitive(v1_api_service_specJSON, "groupPriorityMinimum");
    ...
    // v1_api_service_spec->insecureSkipTLSVerify
    cJSON *insecureSkipTLSVerify = cJSON_GetObjectItemCaseSensitive(v1_api_service_specJSON, "insecureSkipTLSVerify");
    ...
    // v1_api_service_spec->versionPriority
    cJSON *versionPriority = cJSON_GetObjectItemCaseSensitive(v1_api_service_specJSON, "versionPriority");
    if (!versionPriority) {
        goto end;
    }
