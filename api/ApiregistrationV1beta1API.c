...
#include <stdio.h>
#include <ctype.h>
#include "ApiregistrationV1beta1API.h"
...
ApiregistrationV1beta1API_createApiregistrationV1beta1APIService(apiClient_t *apiClient ,v1beta1_api_service_t * body ,char * pretty ,char * dryRun ,char * fieldManager)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/apiregistration.k8s.io/v1beta1/apiservices")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/apiregistration.k8s.io/v1beta1/apiservices");
    ...
    {
        //string
        localVarSingleItemJSON_body = v1beta1_api_service_convertToJSON(body);
...
ApiregistrationV1beta1API_deleteApiregistrationV1beta1APIService(apiClient_t *apiClient ,char * name ,char * pretty ,char * dryRun ,int gracePeriodSeconds ,int orphanDependents ,char * propagationPolicy ,v1_delete_options_t * body)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/apiregistration.k8s.io/v1beta1/apiservices/{name}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/apiregistration.k8s.io/v1beta1/apiservices/{name}");
...
ApiregistrationV1beta1API_getApiregistrationV1beta1APIResources(apiClient_t *apiClient)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/apiregistration.k8s.io/v1beta1/")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/apiregistration.k8s.io/v1beta1/");
...
ApiregistrationV1beta1API_patchApiregistrationV1beta1APIServiceStatus(apiClient_t *apiClient ,char * name , body ,char * pretty ,char * dryRun ,char * fieldManager ,int force)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/apiregistration.k8s.io/v1beta1/apiservices/{name}/status")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/apiregistration.k8s.io/v1beta1/apiservices/{name}/status");
