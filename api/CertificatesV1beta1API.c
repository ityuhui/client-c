...
CertificatesV1beta1API_createCertificatesV1beta1CertificateSigningRequest(apiClient_t *apiClient ,v1beta1_certificate_signing_request_t * body ,char * pretty ,char * dryRun ,char * fieldManager)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/certificates.k8s.io/v1beta1/certificatesigningrequests")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/certificates.k8s.io/v1beta1/certificatesigningrequests");
    ...
    {
        //string
        localVarSingleItemJSON_body = v1beta1_certificate_signing_request_convertToJSON(body);
...
CertificatesV1beta1API_deleteCertificatesV1beta1CertificateSigningRequest(apiClient_t *apiClient ,char * name ,char * pretty ,char * dryRun ,int gracePeriodSeconds ,int orphanDependents ,char * propagationPolicy ,v1_delete_options_t * body)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/certificates.k8s.io/v1beta1/certificatesigningrequests/{name}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/certificates.k8s.io/v1beta1/certificatesigningrequests/{name}");
...
CertificatesV1beta1API_getCertificatesV1beta1APIResources(apiClient_t *apiClient)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/certificates.k8s.io/v1beta1/")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/certificates.k8s.io/v1beta1/");
...
CertificatesV1beta1API_patchCertificatesV1beta1CertificateSigningRequestStatus(apiClient_t *apiClient ,char * name , body ,char * pretty ,char * dryRun ,char * fieldManager ,int force)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/certificates.k8s.io/v1beta1/certificatesigningrequests/{name}/status")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/certificates.k8s.io/v1beta1/certificatesigningrequests/{name}/status");
...
CertificatesV1beta1API_replaceCertificatesV1beta1CertificateSigningRequestApproval(apiClient_t *apiClient ,char * name ,v1beta1_certificate_signing_request_t * body ,char * dryRun ,char * fieldManager ,char * pretty)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/certificates.k8s.io/v1beta1/certificatesigningrequests/{name}/approval")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/certificates.k8s.io/v1beta1/certificatesigningrequests/{name}/approval");
