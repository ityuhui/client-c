...
BatchV1beta1API_createBatchV1beta1NamespacedCronJob(apiClient_t *apiClient ,char * namespace ,v1beta1_cron_job_t * body ,char * pretty ,char * dryRun ,char * fieldManager)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/batch/v1beta1/namespaces/{namespace}/cronjobs")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/batch/v1beta1/namespaces/{namespace}/cronjobs");
    ...
    {
        //string
        localVarSingleItemJSON_body = v1beta1_cron_job_convertToJSON(body);
    ...
    cJSON *BatchV1beta1APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    v1beta1_cron_job_t *elementToReturn = v1beta1_cron_job_parseFromJSON(BatchV1beta1APIlocalVarJSON);
    cJSON_Delete(BatchV1beta1APIlocalVarJSON);
...
BatchV1beta1API_deleteBatchV1beta1CollectionNamespacedCronJob(apiClient_t *apiClient ,char * namespace ,char * pretty ,int allowWatchBookmarks ,char * continue_ ,char * dryRun ,char * fieldSelector ,int gracePeriodSeconds ,char * labelSelector ,int limit ,int orphanDependents ,char * propagationPolicy ,char * resourceVersion ,int timeoutSeconds ,int watch ,v1_delete_options_t * body)
{
    ...
    //nonprimitive not_ container
    cJSON *BatchV1beta1APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    v1_status_t *elementToReturn = v1_status_parseFromJSON(BatchV1beta1APIlocalVarJSON);
    cJSON_Delete(BatchV1beta1APIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
BatchV1beta1API_deleteBatchV1beta1NamespacedCronJob(apiClient_t *apiClient ,char * name ,char * namespace ,char * pretty ,char * dryRun ,int gracePeriodSeconds ,int orphanDependents ,char * propagationPolicy ,v1_delete_options_t * body)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/batch/v1beta1/namespaces/{namespace}/cronjobs/{name}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/batch/v1beta1/namespaces/{namespace}/cronjobs/{name}");
...
BatchV1beta1API_getBatchV1beta1APIResources(apiClient_t *apiClient)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/batch/v1beta1/")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/batch/v1beta1/");
    ...
    //nonprimitive not_ container
    cJSON *BatchV1beta1APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    v1_api_resource_list_t *elementToReturn = v1_api_resource_list_parseFromJSON(BatchV1beta1APIlocalVarJSON);
    cJSON_Delete(BatchV1beta1APIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
BatchV1beta1API_listBatchV1beta1CronJobForAllNamespaces(apiClient_t *apiClient ,int allowWatchBookmarks ,char * continue_ ,char * fieldSelector ,char * labelSelector ,int limit ,char * pretty ,char * resourceVersion ,int timeoutSeconds ,int watch)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/batch/v1beta1/cronjobs")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/batch/v1beta1/cronjobs");
    ...
    //nonprimitive not_ container
    cJSON *BatchV1beta1APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    v1beta1_cron_job_list_t *elementToReturn = v1beta1_cron_job_list_parseFromJSON(BatchV1beta1APIlocalVarJSON);
    cJSON_Delete(BatchV1beta1APIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
//
v1beta1_cron_job_t*
BatchV1beta1API_patchBatchV1beta1NamespacedCronJob(apiClient_t *apiClient ,char * name ,char * namespace , body ,char * pretty ,char * dryRun ,char * fieldManager ,int force)
{
    list_t    *localVarQueryParameters = list_create();
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
...
//
v1beta1_cron_job_t*
BatchV1beta1API_patchBatchV1beta1NamespacedCronJobStatus(apiClient_t *apiClient ,char * name ,char * namespace , body ,char * pretty ,char * dryRun ,char * fieldManager ,int force)
{
    list_t    *localVarQueryParameters = list_create();
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
    ...
    // create the path
    long sizeOfPath = strlen("/apis/batch/v1beta1/namespaces/{namespace}/cronjobs/{name}/status")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/batch/v1beta1/namespaces/{namespace}/cronjobs/{name}/status");
