...
#include <stdio.h>
#include <ctype.h>
#include "RbacAuthorizationV1alpha1API.h"
...
RbacAuthorizationV1alpha1API_createRbacAuthorizationV1alpha1ClusterRole(apiClient_t *apiClient ,v1alpha1_cluster_role_t * body ,char * pretty ,char * dryRun ,char * fieldManager)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/rbac.authorization.k8s.io/v1alpha1/clusterroles")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/rbac.authorization.k8s.io/v1alpha1/clusterroles");
    ...
    {
        //string
        localVarSingleItemJSON_body = v1alpha1_cluster_role_convertToJSON(body);
...
RbacAuthorizationV1alpha1API_createRbacAuthorizationV1alpha1ClusterRoleBinding(apiClient_t *apiClient ,v1alpha1_cluster_role_binding_t * body ,char * pretty ,char * dryRun ,char * fieldManager)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/rbac.authorization.k8s.io/v1alpha1/clusterrolebindings")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/rbac.authorization.k8s.io/v1alpha1/clusterrolebindings");
    ...
    {
        //string
        localVarSingleItemJSON_body = v1alpha1_cluster_role_binding_convertToJSON(body);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_body);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/yaml"); //produces
...
RbacAuthorizationV1alpha1API_createRbacAuthorizationV1alpha1NamespacedRole(apiClient_t *apiClient ,char * namespace ,v1alpha1_role_t * body ,char * pretty ,char * dryRun ,char * fieldManager)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/rbac.authorization.k8s.io/v1alpha1/namespaces/{namespace}/roles")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/rbac.authorization.k8s.io/v1alpha1/namespaces/{namespace}/roles");
    ...
    {
        //string
        localVarSingleItemJSON_body = v1alpha1_role_convertToJSON(body);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_body);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/yaml"); //produces
...
RbacAuthorizationV1alpha1API_createRbacAuthorizationV1alpha1NamespacedRoleBinding(apiClient_t *apiClient ,char * namespace ,v1alpha1_role_binding_t * body ,char * pretty ,char * dryRun ,char * fieldManager)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/rbac.authorization.k8s.io/v1alpha1/namespaces/{namespace}/rolebindings")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/rbac.authorization.k8s.io/v1alpha1/namespaces/{namespace}/rolebindings");
    ...
    {
        //string
        localVarSingleItemJSON_body = v1alpha1_role_binding_convertToJSON(body);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_body);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/yaml"); //produces
...
RbacAuthorizationV1alpha1API_deleteRbacAuthorizationV1alpha1ClusterRole(apiClient_t *apiClient ,char * name ,char * pretty ,char * dryRun ,int gracePeriodSeconds ,int orphanDependents ,char * propagationPolicy ,v1_delete_options_t * body)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/rbac.authorization.k8s.io/v1alpha1/clusterroles/{name}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/rbac.authorization.k8s.io/v1alpha1/clusterroles/{name}");
...
RbacAuthorizationV1alpha1API_deleteRbacAuthorizationV1alpha1ClusterRoleBinding(apiClient_t *apiClient ,char * name ,char * pretty ,char * dryRun ,int gracePeriodSeconds ,int orphanDependents ,char * propagationPolicy ,v1_delete_options_t * body)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/rbac.authorization.k8s.io/v1alpha1/clusterrolebindings/{name}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/rbac.authorization.k8s.io/v1alpha1/clusterrolebindings/{name}");
...
RbacAuthorizationV1alpha1API_deleteRbacAuthorizationV1alpha1NamespacedRole(apiClient_t *apiClient ,char * name ,char * namespace ,char * pretty ,char * dryRun ,int gracePeriodSeconds ,int orphanDependents ,char * propagationPolicy ,v1_delete_options_t * body)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/rbac.authorization.k8s.io/v1alpha1/namespaces/{namespace}/roles/{name}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/rbac.authorization.k8s.io/v1alpha1/namespaces/{namespace}/roles/{name}");
...
RbacAuthorizationV1alpha1API_deleteRbacAuthorizationV1alpha1NamespacedRoleBinding(apiClient_t *apiClient ,char * name ,char * namespace ,char * pretty ,char * dryRun ,int gracePeriodSeconds ,int orphanDependents ,char * propagationPolicy ,v1_delete_options_t * body)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/rbac.authorization.k8s.io/v1alpha1/namespaces/{namespace}/rolebindings/{name}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/rbac.authorization.k8s.io/v1alpha1/namespaces/{namespace}/rolebindings/{name}");
...
RbacAuthorizationV1alpha1API_getRbacAuthorizationV1alpha1APIResources(apiClient_t *apiClient)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/rbac.authorization.k8s.io/v1alpha1/")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/rbac.authorization.k8s.io/v1alpha1/");
...
RbacAuthorizationV1alpha1API_listRbacAuthorizationV1alpha1RoleBindingForAllNamespaces(apiClient_t *apiClient ,int allowWatchBookmarks ,char * continue_ ,char * fieldSelector ,char * labelSelector ,int limit ,char * pretty ,char * resourceVersion ,int timeoutSeconds ,int watch)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/rbac.authorization.k8s.io/v1alpha1/rolebindings")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/rbac.authorization.k8s.io/v1alpha1/rolebindings");
...
RbacAuthorizationV1alpha1API_listRbacAuthorizationV1alpha1RoleForAllNamespaces(apiClient_t *apiClient ,int allowWatchBookmarks ,char * continue_ ,char * fieldSelector ,char * labelSelector ,int limit ,char * pretty ,char * resourceVersion ,int timeoutSeconds ,int watch)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/rbac.authorization.k8s.io/v1alpha1/roles")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/rbac.authorization.k8s.io/v1alpha1/roles");
