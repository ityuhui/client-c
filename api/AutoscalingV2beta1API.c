...
#include <stdio.h>
#include <ctype.h>
#include "AutoscalingV2beta1API.h"
...
AutoscalingV2beta1API_createAutoscalingV2beta1NamespacedHorizontalPodAutoscaler(apiClient_t *apiClient ,char * namespace ,v2beta1_horizontal_pod_autoscaler_t * body ,char * pretty ,char * dryRun ,char * fieldManager)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/autoscaling/v2beta1/namespaces/{namespace}/horizontalpodautoscalers")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/autoscaling/v2beta1/namespaces/{namespace}/horizontalpodautoscalers");
    ...
    {
        //string
        localVarSingleItemJSON_body = v2beta1_horizontal_pod_autoscaler_convertToJSON(body);
    ...
    cJSON *AutoscalingV2beta1APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    v2beta1_horizontal_pod_autoscaler_t *elementToReturn = v2beta1_horizontal_pod_autoscaler_parseFromJSON(AutoscalingV2beta1APIlocalVarJSON);
    cJSON_Delete(AutoscalingV2beta1APIlocalVarJSON);
...
//
v1_status_t*
AutoscalingV2beta1API_deleteAutoscalingV2beta1CollectionNamespacedHorizontalPodAutoscaler(apiClient_t *apiClient ,char * namespace ,char * pretty ,int allowWatchBookmarks ,char * continue ,char * dryRun ,char * fieldSelector ,int gracePeriodSeconds ,char * labelSelector ,int limit ,int orphanDependents ,char * propagationPolicy ,char * resourceVersion ,int timeoutSeconds ,int watch ,v1_delete_options_t * body)
{
    list_t    *localVarQueryParameters = list_create();
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
    ...
    //nonprimitive not container
    cJSON *AutoscalingV2beta1APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    v1_status_t *elementToReturn = v1_status_parseFromJSON(AutoscalingV2beta1APIlocalVarJSON);
    cJSON_Delete(AutoscalingV2beta1APIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
AutoscalingV2beta1API_deleteAutoscalingV2beta1NamespacedHorizontalPodAutoscaler(apiClient_t *apiClient ,char * name ,char * namespace ,char * pretty ,char * dryRun ,int gracePeriodSeconds ,int orphanDependents ,char * propagationPolicy ,v1_delete_options_t * body)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/autoscaling/v2beta1/namespaces/{namespace}/horizontalpodautoscalers/{name}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/autoscaling/v2beta1/namespaces/{namespace}/horizontalpodautoscalers/{name}");
...
AutoscalingV2beta1API_getAutoscalingV2beta1APIResources(apiClient_t *apiClient)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/autoscaling/v2beta1/")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/autoscaling/v2beta1/");
    ...
    //nonprimitive not container
    cJSON *AutoscalingV2beta1APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    v1_api_resource_list_t *elementToReturn = v1_api_resource_list_parseFromJSON(AutoscalingV2beta1APIlocalVarJSON);
    cJSON_Delete(AutoscalingV2beta1APIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
AutoscalingV2beta1API_listAutoscalingV2beta1HorizontalPodAutoscalerForAllNamespaces(apiClient_t *apiClient ,int allowWatchBookmarks ,char * continue ,char * fieldSelector ,char * labelSelector ,int limit ,char * pretty ,char * resourceVersion ,int timeoutSeconds ,int watch)
{
    list_t    *localVarQueryParameters = list_create();
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
    ...
    // create the path
    long sizeOfPath = strlen("/apis/autoscaling/v2beta1/horizontalpodautoscalers")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/autoscaling/v2beta1/horizontalpodautoscalers");
    ...
    //nonprimitive not container
    cJSON *AutoscalingV2beta1APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    v2beta1_horizontal_pod_autoscaler_list_t *elementToReturn = v2beta1_horizontal_pod_autoscaler_list_parseFromJSON(AutoscalingV2beta1APIlocalVarJSON);
    cJSON_Delete(AutoscalingV2beta1APIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
//
v2beta1_horizontal_pod_autoscaler_list_t*
AutoscalingV2beta1API_listAutoscalingV2beta1NamespacedHorizontalPodAutoscaler(apiClient_t *apiClient ,char * namespace ,char * pretty ,int allowWatchBookmarks ,char * continue ,char * fieldSelector ,char * labelSelector ,int limit ,char * resourceVersion ,int timeoutSeconds ,int watch)
{
    list_t    *localVarQueryParameters = list_create();
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
...
AutoscalingV2beta1API_patchAutoscalingV2beta1NamespacedHorizontalPodAutoscalerStatus(apiClient_t *apiClient ,char * name ,char * namespace , body ,char * pretty ,char * dryRun ,char * fieldManager ,int force)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/autoscaling/v2beta1/namespaces/{namespace}/horizontalpodautoscalers/{name}/status")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/autoscaling/v2beta1/namespaces/{namespace}/horizontalpodautoscalers/{name}/status");
