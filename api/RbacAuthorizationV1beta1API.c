...
RbacAuthorizationV1beta1API_createRbacAuthorizationV1beta1ClusterRole(apiClient_t *apiClient ,v1beta1_cluster_role_t * body ,char * pretty ,char * dryRun ,char * fieldManager)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/rbac.authorization.k8s.io/v1beta1/clusterroles")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/rbac.authorization.k8s.io/v1beta1/clusterroles");
    ...
    {
        //string
        localVarSingleItemJSON_body = v1beta1_cluster_role_convertToJSON(body);
    ...
    cJSON *RbacAuthorizationV1beta1APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    v1beta1_cluster_role_t *elementToReturn = v1beta1_cluster_role_parseFromJSON(RbacAuthorizationV1beta1APIlocalVarJSON);
    cJSON_Delete(RbacAuthorizationV1beta1APIlocalVarJSON);
...
RbacAuthorizationV1beta1API_createRbacAuthorizationV1beta1ClusterRoleBinding(apiClient_t *apiClient ,v1beta1_cluster_role_binding_t * body ,char * pretty ,char * dryRun ,char * fieldManager)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/rbac.authorization.k8s.io/v1beta1/clusterrolebindings")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/rbac.authorization.k8s.io/v1beta1/clusterrolebindings");
    ...
    {
        //string
        localVarSingleItemJSON_body = v1beta1_cluster_role_binding_convertToJSON(body);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_body);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/yaml"); //produces
    ...
    //nonprimitive not_ container
    cJSON *RbacAuthorizationV1beta1APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    v1beta1_cluster_role_binding_t *elementToReturn = v1beta1_cluster_role_binding_parseFromJSON(RbacAuthorizationV1beta1APIlocalVarJSON);
    cJSON_Delete(RbacAuthorizationV1beta1APIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
RbacAuthorizationV1beta1API_createRbacAuthorizationV1beta1NamespacedRole(apiClient_t *apiClient ,char * namespace ,v1beta1_role_t * body ,char * pretty ,char * dryRun ,char * fieldManager)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/rbac.authorization.k8s.io/v1beta1/namespaces/{namespace}/roles")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/rbac.authorization.k8s.io/v1beta1/namespaces/{namespace}/roles");
    ...
    {
        //string
        localVarSingleItemJSON_body = v1beta1_role_convertToJSON(body);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_body);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/yaml"); //produces
    ...
    //nonprimitive not_ container
    cJSON *RbacAuthorizationV1beta1APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    v1beta1_role_t *elementToReturn = v1beta1_role_parseFromJSON(RbacAuthorizationV1beta1APIlocalVarJSON);
    cJSON_Delete(RbacAuthorizationV1beta1APIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
RbacAuthorizationV1beta1API_createRbacAuthorizationV1beta1NamespacedRoleBinding(apiClient_t *apiClient ,char * namespace ,v1beta1_role_binding_t * body ,char * pretty ,char * dryRun ,char * fieldManager)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/rbac.authorization.k8s.io/v1beta1/namespaces/{namespace}/rolebindings")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/rbac.authorization.k8s.io/v1beta1/namespaces/{namespace}/rolebindings");
    ...
    {
        //string
        localVarSingleItemJSON_body = v1beta1_role_binding_convertToJSON(body);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_body);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/yaml"); //produces
    ...
    //nonprimitive not_ container
    cJSON *RbacAuthorizationV1beta1APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    v1beta1_role_binding_t *elementToReturn = v1beta1_role_binding_parseFromJSON(RbacAuthorizationV1beta1APIlocalVarJSON);
    cJSON_Delete(RbacAuthorizationV1beta1APIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
RbacAuthorizationV1beta1API_deleteRbacAuthorizationV1beta1ClusterRole(apiClient_t *apiClient ,char * name ,char * pretty ,char * dryRun ,int gracePeriodSeconds ,int orphanDependents ,char * propagationPolicy ,v1_delete_options_t * body)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/rbac.authorization.k8s.io/v1beta1/clusterroles/{name}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/rbac.authorization.k8s.io/v1beta1/clusterroles/{name}");
    ...
    //nonprimitive not_ container
    cJSON *RbacAuthorizationV1beta1APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    v1_status_t *elementToReturn = v1_status_parseFromJSON(RbacAuthorizationV1beta1APIlocalVarJSON);
    cJSON_Delete(RbacAuthorizationV1beta1APIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
RbacAuthorizationV1beta1API_deleteRbacAuthorizationV1beta1ClusterRoleBinding(apiClient_t *apiClient ,char * name ,char * pretty ,char * dryRun ,int gracePeriodSeconds ,int orphanDependents ,char * propagationPolicy ,v1_delete_options_t * body)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/rbac.authorization.k8s.io/v1beta1/clusterrolebindings/{name}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/rbac.authorization.k8s.io/v1beta1/clusterrolebindings/{name}");
...
RbacAuthorizationV1beta1API_deleteRbacAuthorizationV1beta1NamespacedRole(apiClient_t *apiClient ,char * name ,char * namespace ,char * pretty ,char * dryRun ,int gracePeriodSeconds ,int orphanDependents ,char * propagationPolicy ,v1_delete_options_t * body)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/rbac.authorization.k8s.io/v1beta1/namespaces/{namespace}/roles/{name}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/rbac.authorization.k8s.io/v1beta1/namespaces/{namespace}/roles/{name}");
...
RbacAuthorizationV1beta1API_deleteRbacAuthorizationV1beta1NamespacedRoleBinding(apiClient_t *apiClient ,char * name ,char * namespace ,char * pretty ,char * dryRun ,int gracePeriodSeconds ,int orphanDependents ,char * propagationPolicy ,v1_delete_options_t * body)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/rbac.authorization.k8s.io/v1beta1/namespaces/{namespace}/rolebindings/{name}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/rbac.authorization.k8s.io/v1beta1/namespaces/{namespace}/rolebindings/{name}");
...
RbacAuthorizationV1beta1API_getRbacAuthorizationV1beta1APIResources(apiClient_t *apiClient)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/rbac.authorization.k8s.io/v1beta1/")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/rbac.authorization.k8s.io/v1beta1/");
    ...
    //nonprimitive not_ container
    cJSON *RbacAuthorizationV1beta1APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    v1_api_resource_list_t *elementToReturn = v1_api_resource_list_parseFromJSON(RbacAuthorizationV1beta1APIlocalVarJSON);
    cJSON_Delete(RbacAuthorizationV1beta1APIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
RbacAuthorizationV1beta1API_listRbacAuthorizationV1beta1ClusterRole(apiClient_t *apiClient ,char * pretty ,int allowWatchBookmarks ,char * continue_ ,char * fieldSelector ,char * labelSelector ,int limit ,char * resourceVersion ,int timeoutSeconds ,int watch)
{
    ...
    //nonprimitive not_ container
    cJSON *RbacAuthorizationV1beta1APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    v1beta1_cluster_role_list_t *elementToReturn = v1beta1_cluster_role_list_parseFromJSON(RbacAuthorizationV1beta1APIlocalVarJSON);
    cJSON_Delete(RbacAuthorizationV1beta1APIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
RbacAuthorizationV1beta1API_listRbacAuthorizationV1beta1ClusterRoleBinding(apiClient_t *apiClient ,char * pretty ,int allowWatchBookmarks ,char * continue_ ,char * fieldSelector ,char * labelSelector ,int limit ,char * resourceVersion ,int timeoutSeconds ,int watch)
{
    ...
    //nonprimitive not_ container
    cJSON *RbacAuthorizationV1beta1APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    v1beta1_cluster_role_binding_list_t *elementToReturn = v1beta1_cluster_role_binding_list_parseFromJSON(RbacAuthorizationV1beta1APIlocalVarJSON);
    cJSON_Delete(RbacAuthorizationV1beta1APIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
RbacAuthorizationV1beta1API_listRbacAuthorizationV1beta1NamespacedRole(apiClient_t *apiClient ,char * namespace ,char * pretty ,int allowWatchBookmarks ,char * continue_ ,char * fieldSelector ,char * labelSelector ,int limit ,char * resourceVersion ,int timeoutSeconds ,int watch)
{
    ...
    //nonprimitive not_ container
    cJSON *RbacAuthorizationV1beta1APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    v1beta1_role_list_t *elementToReturn = v1beta1_role_list_parseFromJSON(RbacAuthorizationV1beta1APIlocalVarJSON);
    cJSON_Delete(RbacAuthorizationV1beta1APIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
RbacAuthorizationV1beta1API_listRbacAuthorizationV1beta1NamespacedRoleBinding(apiClient_t *apiClient ,char * namespace ,char * pretty ,int allowWatchBookmarks ,char * continue_ ,char * fieldSelector ,char * labelSelector ,int limit ,char * resourceVersion ,int timeoutSeconds ,int watch)
{
    ...
    //nonprimitive not_ container
    cJSON *RbacAuthorizationV1beta1APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    v1beta1_role_binding_list_t *elementToReturn = v1beta1_role_binding_list_parseFromJSON(RbacAuthorizationV1beta1APIlocalVarJSON);
    cJSON_Delete(RbacAuthorizationV1beta1APIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
RbacAuthorizationV1beta1API_listRbacAuthorizationV1beta1RoleBindingForAllNamespaces(apiClient_t *apiClient ,int allowWatchBookmarks ,char * continue_ ,char * fieldSelector ,char * labelSelector ,int limit ,char * pretty ,char * resourceVersion ,int timeoutSeconds ,int watch)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/rbac.authorization.k8s.io/v1beta1/rolebindings")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/rbac.authorization.k8s.io/v1beta1/rolebindings");
...
RbacAuthorizationV1beta1API_listRbacAuthorizationV1beta1RoleForAllNamespaces(apiClient_t *apiClient ,int allowWatchBookmarks ,char * continue_ ,char * fieldSelector ,char * labelSelector ,int limit ,char * pretty ,char * resourceVersion ,int timeoutSeconds ,int watch)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/rbac.authorization.k8s.io/v1beta1/roles")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/rbac.authorization.k8s.io/v1beta1/roles");
