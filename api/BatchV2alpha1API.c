...
BatchV2alpha1API_createBatchV2alpha1NamespacedCronJob(apiClient_t *apiClient ,char * namespace ,v2alpha1_cron_job_t * body ,char * pretty ,char * dryRun ,char * fieldManager)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/batch/v2alpha1/namespaces/{namespace}/cronjobs")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/batch/v2alpha1/namespaces/{namespace}/cronjobs");
    ...
    {
        //string
        localVarSingleItemJSON_body = v2alpha1_cron_job_convertToJSON(body);
...
BatchV2alpha1API_deleteBatchV2alpha1NamespacedCronJob(apiClient_t *apiClient ,char * name ,char * namespace ,char * pretty ,char * dryRun ,int gracePeriodSeconds ,int orphanDependents ,char * propagationPolicy ,v1_delete_options_t * body)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/batch/v2alpha1/namespaces/{namespace}/cronjobs/{name}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/batch/v2alpha1/namespaces/{namespace}/cronjobs/{name}");
...
BatchV2alpha1API_getBatchV2alpha1APIResources(apiClient_t *apiClient)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/batch/v2alpha1/")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/batch/v2alpha1/");
...
BatchV2alpha1API_listBatchV2alpha1CronJobForAllNamespaces(apiClient_t *apiClient ,int allowWatchBookmarks ,char * continue ,char * fieldSelector ,char * labelSelector ,int limit ,char * pretty ,char * resourceVersion ,int timeoutSeconds ,int watch)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/batch/v2alpha1/cronjobs")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/batch/v2alpha1/cronjobs");
...
BatchV2alpha1API_patchBatchV2alpha1NamespacedCronJobStatus(apiClient_t *apiClient ,char * name ,char * namespace , body ,char * pretty ,char * dryRun ,char * fieldManager ,int force)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/batch/v2alpha1/namespaces/{namespace}/cronjobs/{name}/status")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/batch/v2alpha1/namespaces/{namespace}/cronjobs/{name}/status");
