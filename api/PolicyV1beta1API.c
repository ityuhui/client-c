...
PolicyV1beta1API_createPolicyV1beta1NamespacedPodDisruptionBudget(apiClient_t *apiClient ,char * namespace ,v1beta1_pod_disruption_budget_t * body ,char * pretty ,char * dryRun ,char * fieldManager)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/policy/v1beta1/namespaces/{namespace}/poddisruptionbudgets")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/policy/v1beta1/namespaces/{namespace}/poddisruptionbudgets");
    ...
    {
        //string
        localVarSingleItemJSON_body = v1beta1_pod_disruption_budget_convertToJSON(body);
...
PolicyV1beta1API_createPolicyV1beta1PodSecurityPolicy(apiClient_t *apiClient ,policy_v1beta1_pod_security_policy_t * body ,char * pretty ,char * dryRun ,char * fieldManager)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/policy/v1beta1/podsecuritypolicies")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/policy/v1beta1/podsecuritypolicies");
...
PolicyV1beta1API_deletePolicyV1beta1NamespacedPodDisruptionBudget(apiClient_t *apiClient ,char * name ,char * namespace ,char * pretty ,char * dryRun ,int gracePeriodSeconds ,int orphanDependents ,char * propagationPolicy ,v1_delete_options_t * body)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/policy/v1beta1/namespaces/{namespace}/poddisruptionbudgets/{name}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/policy/v1beta1/namespaces/{namespace}/poddisruptionbudgets/{name}");
...
PolicyV1beta1API_deletePolicyV1beta1PodSecurityPolicy(apiClient_t *apiClient ,char * name ,char * pretty ,char * dryRun ,int gracePeriodSeconds ,int orphanDependents ,char * propagationPolicy ,v1_delete_options_t * body)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/policy/v1beta1/podsecuritypolicies/{name}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/policy/v1beta1/podsecuritypolicies/{name}");
...
PolicyV1beta1API_getPolicyV1beta1APIResources(apiClient_t *apiClient)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/policy/v1beta1/")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/policy/v1beta1/");
...
PolicyV1beta1API_listPolicyV1beta1PodDisruptionBudgetForAllNamespaces(apiClient_t *apiClient ,int allowWatchBookmarks ,char * continue_ ,char * fieldSelector ,char * labelSelector ,int limit ,char * pretty ,char * resourceVersion ,int timeoutSeconds ,int watch)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/policy/v1beta1/poddisruptionbudgets")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/policy/v1beta1/poddisruptionbudgets");
...
PolicyV1beta1API_patchPolicyV1beta1NamespacedPodDisruptionBudgetStatus(apiClient_t *apiClient ,char * name ,char * namespace , body ,char * pretty ,char * dryRun ,char * fieldManager ,int force)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/policy/v1beta1/namespaces/{namespace}/poddisruptionbudgets/{name}/status")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/policy/v1beta1/namespaces/{namespace}/poddisruptionbudgets/{name}/status");
