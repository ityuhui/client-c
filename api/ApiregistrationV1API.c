...
ApiregistrationV1API_createApiregistrationV1APIService(apiClient_t *apiClient ,v1_api_service_t * body ,char * pretty ,char * dryRun ,char * fieldManager)
{
    ...
    cJSON *ApiregistrationV1APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    v1_api_service_t *elementToReturn = v1_api_service_parseFromJSON(ApiregistrationV1APIlocalVarJSON);
    cJSON_Delete(ApiregistrationV1APIlocalVarJSON);
...
ApiregistrationV1API_listApiregistrationV1APIService(apiClient_t *apiClient ,char * pretty ,int allowWatchBookmarks ,char * continue_ ,char * fieldSelector ,char * labelSelector ,int limit ,char * resourceVersion ,int timeoutSeconds ,int watch)
{
    list_t    *localVarQueryParameters = list_create();
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
...
//
v1_api_service_t*
ApiregistrationV1API_patchApiregistrationV1APIService(apiClient_t *apiClient ,char * name , object_t * body ,char * pretty ,char * dryRun ,char * fieldManager ,int force)
{
    list_t    *localVarQueryParameters = list_create();
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
...
//
v1_api_service_t*
ApiregistrationV1API_patchApiregistrationV1APIServiceStatus(apiClient_t *apiClient ,char * name , object_t * body ,char * pretty ,char * dryRun ,char * fieldManager ,int force)
{
    list_t    *localVarQueryParameters = list_create();
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
