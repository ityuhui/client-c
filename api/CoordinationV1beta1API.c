...
#include <stdio.h>
#include <ctype.h>
#include "CoordinationV1beta1API.h"
...
CoordinationV1beta1API_createCoordinationV1beta1NamespacedLease(apiClient_t *apiClient ,char * namespace ,v1beta1_lease_t * body ,char * pretty ,char * dryRun ,char * fieldManager)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/coordination.k8s.io/v1beta1/namespaces/{namespace}/leases")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/coordination.k8s.io/v1beta1/namespaces/{namespace}/leases");
    ...
    {
        //string
        localVarSingleItemJSON_body = v1beta1_lease_convertToJSON(body);
    ...
    cJSON *CoordinationV1beta1APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    v1beta1_lease_t *elementToReturn = v1beta1_lease_parseFromJSON(CoordinationV1beta1APIlocalVarJSON);
    cJSON_Delete(CoordinationV1beta1APIlocalVarJSON);
...
CoordinationV1beta1API_deleteCoordinationV1beta1CollectionNamespacedLease(apiClient_t *apiClient ,char * namespace ,char * pretty ,int allowWatchBookmarks ,char * continue ,char * dryRun ,char * fieldSelector ,int gracePeriodSeconds ,char * labelSelector ,int limit ,int orphanDependents ,char * propagationPolicy ,char * resourceVersion ,int timeoutSeconds ,int watch ,v1_delete_options_t * body)
{
    ...
    //nonprimitive not container
    cJSON *CoordinationV1beta1APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    v1_status_t *elementToReturn = v1_status_parseFromJSON(CoordinationV1beta1APIlocalVarJSON);
    cJSON_Delete(CoordinationV1beta1APIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
CoordinationV1beta1API_deleteCoordinationV1beta1NamespacedLease(apiClient_t *apiClient ,char * name ,char * namespace ,char * pretty ,char * dryRun ,int gracePeriodSeconds ,int orphanDependents ,char * propagationPolicy ,v1_delete_options_t * body)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/coordination.k8s.io/v1beta1/namespaces/{namespace}/leases/{name}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/coordination.k8s.io/v1beta1/namespaces/{namespace}/leases/{name}");
...
CoordinationV1beta1API_getCoordinationV1beta1APIResources(apiClient_t *apiClient)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/coordination.k8s.io/v1beta1/")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/coordination.k8s.io/v1beta1/");
    ...
    //nonprimitive not container
    cJSON *CoordinationV1beta1APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    v1_api_resource_list_t *elementToReturn = v1_api_resource_list_parseFromJSON(CoordinationV1beta1APIlocalVarJSON);
    cJSON_Delete(CoordinationV1beta1APIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
CoordinationV1beta1API_listCoordinationV1beta1LeaseForAllNamespaces(apiClient_t *apiClient ,int allowWatchBookmarks ,char * continue ,char * fieldSelector ,char * labelSelector ,int limit ,char * pretty ,char * resourceVersion ,int timeoutSeconds ,int watch)
{
    list_t    *localVarQueryParameters = list_create();
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
    ...
    // create the path
    long sizeOfPath = strlen("/apis/coordination.k8s.io/v1beta1/leases")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/coordination.k8s.io/v1beta1/leases");
    ...
    //nonprimitive not container
    cJSON *CoordinationV1beta1APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    v1beta1_lease_list_t *elementToReturn = v1beta1_lease_list_parseFromJSON(CoordinationV1beta1APIlocalVarJSON);
    cJSON_Delete(CoordinationV1beta1APIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
//
v1beta1_lease_list_t*
CoordinationV1beta1API_listCoordinationV1beta1NamespacedLease(apiClient_t *apiClient ,char * namespace ,char * pretty ,int allowWatchBookmarks ,char * continue ,char * fieldSelector ,char * labelSelector ,int limit ,char * resourceVersion ,int timeoutSeconds ,int watch)
{
    list_t    *localVarQueryParameters = list_create();
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
