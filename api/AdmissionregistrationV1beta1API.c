...
AdmissionregistrationV1beta1API_createAdmissionregistrationV1beta1MutatingWebhookConfiguration(apiClient_t *apiClient ,v1beta1_mutating_webhook_configuration_t * body ,char * pretty ,char * dryRun ,char * fieldManager)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/admissionregistration.k8s.io/v1beta1/mutatingwebhookconfigurations")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/admissionregistration.k8s.io/v1beta1/mutatingwebhookconfigurations");
    ...
    {
        //string
        localVarSingleItemJSON_body = v1beta1_mutating_webhook_configuration_convertToJSON(body);
    ...
    cJSON *AdmissionregistrationV1beta1APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    v1beta1_mutating_webhook_configuration_t *elementToReturn = v1beta1_mutating_webhook_configuration_parseFromJSON(AdmissionregistrationV1beta1APIlocalVarJSON);
    cJSON_Delete(AdmissionregistrationV1beta1APIlocalVarJSON);
...
AdmissionregistrationV1beta1API_createAdmissionregistrationV1beta1ValidatingWebhookConfiguration(apiClient_t *apiClient ,v1beta1_validating_webhook_configuration_t * body ,char * pretty ,char * dryRun ,char * fieldManager)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/admissionregistration.k8s.io/v1beta1/validatingwebhookconfigurations")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/admissionregistration.k8s.io/v1beta1/validatingwebhookconfigurations");
    ...
    {
        //string
        localVarSingleItemJSON_body = v1beta1_validating_webhook_configuration_convertToJSON(body);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_body);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/yaml"); //produces
    ...
    //nonprimitive not_ container
    cJSON *AdmissionregistrationV1beta1APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    v1beta1_validating_webhook_configuration_t *elementToReturn = v1beta1_validating_webhook_configuration_parseFromJSON(AdmissionregistrationV1beta1APIlocalVarJSON);
    cJSON_Delete(AdmissionregistrationV1beta1APIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
AdmissionregistrationV1beta1API_deleteAdmissionregistrationV1beta1MutatingWebhookConfiguration(apiClient_t *apiClient ,char * name ,char * pretty ,char * dryRun ,int gracePeriodSeconds ,int orphanDependents ,char * propagationPolicy ,v1_delete_options_t * body)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/admissionregistration.k8s.io/v1beta1/mutatingwebhookconfigurations/{name}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/admissionregistration.k8s.io/v1beta1/mutatingwebhookconfigurations/{name}");
...
AdmissionregistrationV1beta1API_deleteAdmissionregistrationV1beta1ValidatingWebhookConfiguration(apiClient_t *apiClient ,char * name ,char * pretty ,char * dryRun ,int gracePeriodSeconds ,int orphanDependents ,char * propagationPolicy ,v1_delete_options_t * body)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/admissionregistration.k8s.io/v1beta1/validatingwebhookconfigurations/{name}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/admissionregistration.k8s.io/v1beta1/validatingwebhookconfigurations/{name}");
...
AdmissionregistrationV1beta1API_listAdmissionregistrationV1beta1MutatingWebhookConfiguration(apiClient_t *apiClient ,char * pretty ,int allowWatchBookmarks ,char * continue_ ,char * fieldSelector ,char * labelSelector ,int limit ,char * resourceVersion ,int timeoutSeconds ,int watch)
{
    ...
    //nonprimitive not_ container
    cJSON *AdmissionregistrationV1beta1APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    v1beta1_mutating_webhook_configuration_list_t *elementToReturn = v1beta1_mutating_webhook_configuration_list_parseFromJSON(AdmissionregistrationV1beta1APIlocalVarJSON);
    cJSON_Delete(AdmissionregistrationV1beta1APIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
AdmissionregistrationV1beta1API_listAdmissionregistrationV1beta1ValidatingWebhookConfiguration(apiClient_t *apiClient ,char * pretty ,int allowWatchBookmarks ,char * continue_ ,char * fieldSelector ,char * labelSelector ,int limit ,char * resourceVersion ,int timeoutSeconds ,int watch)
{
    ...
    //nonprimitive not_ container
    cJSON *AdmissionregistrationV1beta1APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    v1beta1_validating_webhook_configuration_list_t *elementToReturn = v1beta1_validating_webhook_configuration_list_parseFromJSON(AdmissionregistrationV1beta1APIlocalVarJSON);
    cJSON_Delete(AdmissionregistrationV1beta1APIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
//
v1beta1_mutating_webhook_configuration_t*
AdmissionregistrationV1beta1API_patchAdmissionregistrationV1beta1MutatingWebhookConfiguration(apiClient_t *apiClient ,char * name , object_t * body ,char * pretty ,char * dryRun ,char * fieldManager ,int force)
{
    list_t    *localVarQueryParameters = list_create();
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
...
//
v1beta1_validating_webhook_configuration_t*
AdmissionregistrationV1beta1API_patchAdmissionregistrationV1beta1ValidatingWebhookConfiguration(apiClient_t *apiClient ,char * name , object_t * body ,char * pretty ,char * dryRun ,char * fieldManager ,int force)
{
    list_t    *localVarQueryParameters = list_create();
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
