...
#include <stdio.h>
#include <ctype.h>
#include "SchedulingV1beta1API.h"
...
SchedulingV1beta1API_createSchedulingV1beta1PriorityClass(apiClient_t *apiClient ,v1beta1_priority_class_t * body ,char * pretty ,char * dryRun ,char * fieldManager)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/scheduling.k8s.io/v1beta1/priorityclasses")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/scheduling.k8s.io/v1beta1/priorityclasses");
    ...
    {
        //string
        localVarSingleItemJSON_body = v1beta1_priority_class_convertToJSON(body);
...
SchedulingV1beta1API_deleteSchedulingV1beta1PriorityClass(apiClient_t *apiClient ,char * name ,char * pretty ,char * dryRun ,int gracePeriodSeconds ,int orphanDependents ,char * propagationPolicy ,v1_delete_options_t * body)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/scheduling.k8s.io/v1beta1/priorityclasses/{name}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/scheduling.k8s.io/v1beta1/priorityclasses/{name}");
...
SchedulingV1beta1API_getSchedulingV1beta1APIResources(apiClient_t *apiClient)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/scheduling.k8s.io/v1beta1/")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/scheduling.k8s.io/v1beta1/");
...
//
v1beta1_priority_class_t*
SchedulingV1beta1API_patchSchedulingV1beta1PriorityClass(apiClient_t *apiClient ,char * name , object_t * body ,char * pretty ,char * dryRun ,char * fieldManager ,int force)
{
    list_t    *localVarQueryParameters = list_create();
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
