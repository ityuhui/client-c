...
AuthorizationV1beta1API_createAuthorizationV1beta1NamespacedLocalSubjectAccessReview(apiClient_t *apiClient ,char * namespace ,v1beta1_local_subject_access_review_t * body ,char * dryRun ,char * fieldManager ,char * pretty)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/authorization.k8s.io/v1beta1/namespaces/{namespace}/localsubjectaccessreviews")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/authorization.k8s.io/v1beta1/namespaces/{namespace}/localsubjectaccessreviews");
    ...
    {
        //string
        localVarSingleItemJSON_body = v1beta1_local_subject_access_review_convertToJSON(body);
    ...
    cJSON *AuthorizationV1beta1APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    v1beta1_local_subject_access_review_t *elementToReturn = v1beta1_local_subject_access_review_parseFromJSON(AuthorizationV1beta1APIlocalVarJSON);
    cJSON_Delete(AuthorizationV1beta1APIlocalVarJSON);
...
AuthorizationV1beta1API_createAuthorizationV1beta1SelfSubjectAccessReview(apiClient_t *apiClient ,v1beta1_self_subject_access_review_t * body ,char * dryRun ,char * fieldManager ,char * pretty)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/authorization.k8s.io/v1beta1/selfsubjectaccessreviews")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/authorization.k8s.io/v1beta1/selfsubjectaccessreviews");
    ...
    {
        //string
        localVarSingleItemJSON_body = v1beta1_self_subject_access_review_convertToJSON(body);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_body);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/yaml"); //produces
    ...
    //nonprimitive not_ container
    cJSON *AuthorizationV1beta1APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    v1beta1_self_subject_access_review_t *elementToReturn = v1beta1_self_subject_access_review_parseFromJSON(AuthorizationV1beta1APIlocalVarJSON);
    cJSON_Delete(AuthorizationV1beta1APIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
AuthorizationV1beta1API_createAuthorizationV1beta1SelfSubjectRulesReview(apiClient_t *apiClient ,v1beta1_self_subject_rules_review_t * body ,char * dryRun ,char * fieldManager ,char * pretty)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/authorization.k8s.io/v1beta1/selfsubjectrulesreviews")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/authorization.k8s.io/v1beta1/selfsubjectrulesreviews");
    ...
    {
        //string
        localVarSingleItemJSON_body = v1beta1_self_subject_rules_review_convertToJSON(body);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_body);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/yaml"); //produces
    ...
    //nonprimitive not_ container
    cJSON *AuthorizationV1beta1APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    v1beta1_self_subject_rules_review_t *elementToReturn = v1beta1_self_subject_rules_review_parseFromJSON(AuthorizationV1beta1APIlocalVarJSON);
    cJSON_Delete(AuthorizationV1beta1APIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
AuthorizationV1beta1API_createAuthorizationV1beta1SubjectAccessReview(apiClient_t *apiClient ,v1beta1_subject_access_review_t * body ,char * dryRun ,char * fieldManager ,char * pretty)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/authorization.k8s.io/v1beta1/subjectaccessreviews")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/authorization.k8s.io/v1beta1/subjectaccessreviews");
    ...
    {
        //string
        localVarSingleItemJSON_body = v1beta1_subject_access_review_convertToJSON(body);
        localVarBodyParameters = cJSON_Print(localVarSingleItemJSON_body);
    }
    list_addElement(localVarHeaderType,"application/json"); //produces
    list_addElement(localVarHeaderType,"application/yaml"); //produces
    ...
    //nonprimitive not_ container
    cJSON *AuthorizationV1beta1APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    v1beta1_subject_access_review_t *elementToReturn = v1beta1_subject_access_review_parseFromJSON(AuthorizationV1beta1APIlocalVarJSON);
    cJSON_Delete(AuthorizationV1beta1APIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
AuthorizationV1beta1API_getAuthorizationV1beta1APIResources(apiClient_t *apiClient)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/authorization.k8s.io/v1beta1/")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/authorization.k8s.io/v1beta1/");
    ...
    //nonprimitive not_ container
    cJSON *AuthorizationV1beta1APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    v1_api_resource_list_t *elementToReturn = v1_api_resource_list_parseFromJSON(AuthorizationV1beta1APIlocalVarJSON);
    cJSON_Delete(AuthorizationV1beta1APIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
