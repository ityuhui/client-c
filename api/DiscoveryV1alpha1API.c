...
#include <stdio.h>
#include <ctype.h>
#include "DiscoveryV1alpha1API.h"
...
DiscoveryV1alpha1API_createDiscoveryV1alpha1NamespacedEndpointSlice(apiClient_t *apiClient ,char * namespace ,v1alpha1_endpoint_slice_t * body ,char * pretty ,char * dryRun ,char * fieldManager)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/discovery.k8s.io/v1alpha1/namespaces/{namespace}/endpointslices")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/discovery.k8s.io/v1alpha1/namespaces/{namespace}/endpointslices");
    ...
    {
        //string
        localVarSingleItemJSON_body = v1alpha1_endpoint_slice_convertToJSON(body);
...
DiscoveryV1alpha1API_deleteDiscoveryV1alpha1NamespacedEndpointSlice(apiClient_t *apiClient ,char * name ,char * namespace ,char * pretty ,char * dryRun ,int gracePeriodSeconds ,int orphanDependents ,char * propagationPolicy ,v1_delete_options_t * body)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/discovery.k8s.io/v1alpha1/namespaces/{namespace}/endpointslices/{name}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/discovery.k8s.io/v1alpha1/namespaces/{namespace}/endpointslices/{name}");
...
DiscoveryV1alpha1API_getDiscoveryV1alpha1APIResources(apiClient_t *apiClient)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/discovery.k8s.io/v1alpha1/")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/discovery.k8s.io/v1alpha1/");
...
DiscoveryV1alpha1API_listDiscoveryV1alpha1EndpointSliceForAllNamespaces(apiClient_t *apiClient ,int allowWatchBookmarks ,char * continue ,char * fieldSelector ,char * labelSelector ,int limit ,char * pretty ,char * resourceVersion ,int timeoutSeconds ,int watch)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/discovery.k8s.io/v1alpha1/endpointslices")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/discovery.k8s.io/v1alpha1/endpointslices");
