...
EventsV1beta1API_createEventsV1beta1NamespacedEvent(apiClient_t *apiClient ,char * namespace ,v1beta1_event_t * body ,char * pretty ,char * dryRun ,char * fieldManager)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/events.k8s.io/v1beta1/namespaces/{namespace}/events")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/events.k8s.io/v1beta1/namespaces/{namespace}/events");
    ...
    {
        //string
        localVarSingleItemJSON_body = v1beta1_event_convertToJSON(body);
    ...
    cJSON *EventsV1beta1APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    v1beta1_event_t *elementToReturn = v1beta1_event_parseFromJSON(EventsV1beta1APIlocalVarJSON);
    cJSON_Delete(EventsV1beta1APIlocalVarJSON);
...
EventsV1beta1API_deleteEventsV1beta1CollectionNamespacedEvent(apiClient_t *apiClient ,char * namespace ,char * pretty ,int allowWatchBookmarks ,char * continue ,char * dryRun ,char * fieldSelector ,int gracePeriodSeconds ,char * labelSelector ,int limit ,int orphanDependents ,char * propagationPolicy ,char * resourceVersion ,int timeoutSeconds ,int watch ,v1_delete_options_t * body)
{
    ...
    //nonprimitive not container
    cJSON *EventsV1beta1APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    v1_status_t *elementToReturn = v1_status_parseFromJSON(EventsV1beta1APIlocalVarJSON);
    cJSON_Delete(EventsV1beta1APIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
EventsV1beta1API_deleteEventsV1beta1NamespacedEvent(apiClient_t *apiClient ,char * name ,char * namespace ,char * pretty ,char * dryRun ,int gracePeriodSeconds ,int orphanDependents ,char * propagationPolicy ,v1_delete_options_t * body)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/events.k8s.io/v1beta1/namespaces/{namespace}/events/{name}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/events.k8s.io/v1beta1/namespaces/{namespace}/events/{name}");
...
EventsV1beta1API_getEventsV1beta1APIResources(apiClient_t *apiClient)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/events.k8s.io/v1beta1/")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/events.k8s.io/v1beta1/");
    ...
    //nonprimitive not container
    cJSON *EventsV1beta1APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    v1_api_resource_list_t *elementToReturn = v1_api_resource_list_parseFromJSON(EventsV1beta1APIlocalVarJSON);
    cJSON_Delete(EventsV1beta1APIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
EventsV1beta1API_listEventsV1beta1EventForAllNamespaces(apiClient_t *apiClient ,int allowWatchBookmarks ,char * continue ,char * fieldSelector ,char * labelSelector ,int limit ,char * pretty ,char * resourceVersion ,int timeoutSeconds ,int watch)
{
    list_t    *localVarQueryParameters = list_create();
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
    ...
    // create the path
    long sizeOfPath = strlen("/apis/events.k8s.io/v1beta1/events")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/events.k8s.io/v1beta1/events");
    ...
    //nonprimitive not container
    cJSON *EventsV1beta1APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    v1beta1_event_list_t *elementToReturn = v1beta1_event_list_parseFromJSON(EventsV1beta1APIlocalVarJSON);
    cJSON_Delete(EventsV1beta1APIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
//
v1beta1_event_list_t*
EventsV1beta1API_listEventsV1beta1NamespacedEvent(apiClient_t *apiClient ,char * namespace ,char * pretty ,int allowWatchBookmarks ,char * continue ,char * fieldSelector ,char * labelSelector ,int limit ,char * resourceVersion ,int timeoutSeconds ,int watch)
{
    list_t    *localVarQueryParameters = list_create();
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
