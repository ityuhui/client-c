...
StorageV1alpha1API_createStorageV1alpha1VolumeAttachment(apiClient_t *apiClient ,v1alpha1_volume_attachment_t * body ,char * pretty ,char * dryRun ,char * fieldManager)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/storage.k8s.io/v1alpha1/volumeattachments")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/storage.k8s.io/v1alpha1/volumeattachments");
    ...
    {
        //string
        localVarSingleItemJSON_body = v1alpha1_volume_attachment_convertToJSON(body);
    ...
    cJSON *StorageV1alpha1APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    v1alpha1_volume_attachment_t *elementToReturn = v1alpha1_volume_attachment_parseFromJSON(StorageV1alpha1APIlocalVarJSON);
    cJSON_Delete(StorageV1alpha1APIlocalVarJSON);
...
StorageV1alpha1API_deleteStorageV1alpha1VolumeAttachment(apiClient_t *apiClient ,char * name ,char * pretty ,char * dryRun ,int gracePeriodSeconds ,int orphanDependents ,char * propagationPolicy ,v1_delete_options_t * body)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/storage.k8s.io/v1alpha1/volumeattachments/{name}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/storage.k8s.io/v1alpha1/volumeattachments/{name}");
...
StorageV1alpha1API_listStorageV1alpha1VolumeAttachment(apiClient_t *apiClient ,char * pretty ,int allowWatchBookmarks ,char * continue_ ,char * fieldSelector ,char * labelSelector ,int limit ,char * resourceVersion ,int timeoutSeconds ,int watch)
{
    ...
    //nonprimitive not_ container
    cJSON *StorageV1alpha1APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    v1alpha1_volume_attachment_list_t *elementToReturn = v1alpha1_volume_attachment_list_parseFromJSON(StorageV1alpha1APIlocalVarJSON);
    cJSON_Delete(StorageV1alpha1APIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
