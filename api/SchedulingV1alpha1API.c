...
#include <stdio.h>
#include <ctype.h>
#include "SchedulingV1alpha1API.h"
...
SchedulingV1alpha1API_createSchedulingV1alpha1PriorityClass(apiClient_t *apiClient ,v1alpha1_priority_class_t * body ,char * pretty ,char * dryRun ,char * fieldManager)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/scheduling.k8s.io/v1alpha1/priorityclasses")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/scheduling.k8s.io/v1alpha1/priorityclasses");
    ...
    {
        //string
        localVarSingleItemJSON_body = v1alpha1_priority_class_convertToJSON(body);
    ...
    cJSON *SchedulingV1alpha1APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    v1alpha1_priority_class_t *elementToReturn = v1alpha1_priority_class_parseFromJSON(SchedulingV1alpha1APIlocalVarJSON);
    cJSON_Delete(SchedulingV1alpha1APIlocalVarJSON);
...
SchedulingV1alpha1API_deleteSchedulingV1alpha1CollectionPriorityClass(apiClient_t *apiClient ,char * pretty ,int allowWatchBookmarks ,char * continue ,char * dryRun ,char * fieldSelector ,int gracePeriodSeconds ,char * labelSelector ,int limit ,int orphanDependents ,char * propagationPolicy ,char * resourceVersion ,int timeoutSeconds ,int watch ,v1_delete_options_t * body)
{
    ...
    //nonprimitive not container
    cJSON *SchedulingV1alpha1APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    v1_status_t *elementToReturn = v1_status_parseFromJSON(SchedulingV1alpha1APIlocalVarJSON);
    cJSON_Delete(SchedulingV1alpha1APIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
SchedulingV1alpha1API_deleteSchedulingV1alpha1PriorityClass(apiClient_t *apiClient ,char * name ,char * pretty ,char * dryRun ,int gracePeriodSeconds ,int orphanDependents ,char * propagationPolicy ,v1_delete_options_t * body)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/scheduling.k8s.io/v1alpha1/priorityclasses/{name}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/scheduling.k8s.io/v1alpha1/priorityclasses/{name}");
...
SchedulingV1alpha1API_getSchedulingV1alpha1APIResources(apiClient_t *apiClient)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/scheduling.k8s.io/v1alpha1/")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/scheduling.k8s.io/v1alpha1/");
    ...
    //nonprimitive not container
    cJSON *SchedulingV1alpha1APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    v1_api_resource_list_t *elementToReturn = v1_api_resource_list_parseFromJSON(SchedulingV1alpha1APIlocalVarJSON);
    cJSON_Delete(SchedulingV1alpha1APIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
SchedulingV1alpha1API_listSchedulingV1alpha1PriorityClass(apiClient_t *apiClient ,char * pretty ,int allowWatchBookmarks ,char * continue ,char * fieldSelector ,char * labelSelector ,int limit ,char * resourceVersion ,int timeoutSeconds ,int watch)
{
    list_t    *localVarQueryParameters = list_create();
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
    ...
    //nonprimitive not container
    cJSON *SchedulingV1alpha1APIlocalVarJSON = cJSON_Parse(apiClient->dataReceived);
    v1alpha1_priority_class_list_t *elementToReturn = v1alpha1_priority_class_list_parseFromJSON(SchedulingV1alpha1APIlocalVarJSON);
    cJSON_Delete(SchedulingV1alpha1APIlocalVarJSON);
    if(elementToReturn == NULL) {
        // return 0;
    }
...
//
v1alpha1_priority_class_t*
SchedulingV1alpha1API_patchSchedulingV1alpha1PriorityClass(apiClient_t *apiClient ,char * name , body ,char * pretty ,char * dryRun ,char * fieldManager ,int force)
{
    list_t    *localVarQueryParameters = list_create();
    list_t    *localVarHeaderParameters = NULL;
    list_t    *localVarFormParameters = NULL;
