...
NetworkingV1beta1API_createNetworkingV1beta1NamespacedIngress(apiClient_t *apiClient ,char * namespace ,networking_v1beta1_ingress_t * body ,char * pretty ,char * dryRun ,char * fieldManager)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/networking.k8s.io/v1beta1/namespaces/{namespace}/ingresses")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/networking.k8s.io/v1beta1/namespaces/{namespace}/ingresses");
    ...
    {
        //string
        localVarSingleItemJSON_body = networking_v1beta1_ingress_convertToJSON(body);
...
NetworkingV1beta1API_deleteNetworkingV1beta1NamespacedIngress(apiClient_t *apiClient ,char * name ,char * namespace ,char * pretty ,char * dryRun ,int gracePeriodSeconds ,int orphanDependents ,char * propagationPolicy ,v1_delete_options_t * body)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/networking.k8s.io/v1beta1/namespaces/{namespace}/ingresses/{name}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/networking.k8s.io/v1beta1/namespaces/{namespace}/ingresses/{name}");
...
NetworkingV1beta1API_listNetworkingV1beta1IngressForAllNamespaces(apiClient_t *apiClient ,int allowWatchBookmarks ,char * continue ,char * fieldSelector ,char * labelSelector ,int limit ,char * pretty ,char * resourceVersion ,int timeoutSeconds ,int watch)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/networking.k8s.io/v1beta1/ingresses")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/networking.k8s.io/v1beta1/ingresses");
...
NetworkingV1beta1API_patchNetworkingV1beta1NamespacedIngressStatus(apiClient_t *apiClient ,char * name ,char * namespace , body ,char * pretty ,char * dryRun ,char * fieldManager ,int force)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/networking.k8s.io/v1beta1/namespaces/{namespace}/ingresses/{name}/status")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/networking.k8s.io/v1beta1/namespaces/{namespace}/ingresses/{name}/status");
