...
#include <stdio.h>
#include <ctype.h>
#include "AutoscalingV2beta2API.h"
...
AutoscalingV2beta2API_createAutoscalingV2beta2NamespacedHorizontalPodAutoscaler(apiClient_t *apiClient ,char * namespace ,v2beta2_horizontal_pod_autoscaler_t * body ,char * pretty ,char * dryRun ,char * fieldManager)
{
    ...
    {
        //string
        localVarSingleItemJSON_body = v2beta2_horizontal_pod_autoscaler_convertToJSON(body);
...
AutoscalingV2beta2API_deleteAutoscalingV2beta2NamespacedHorizontalPodAutoscaler(apiClient_t *apiClient ,char * name ,char * namespace ,char * pretty ,char * dryRun ,int gracePeriodSeconds ,int orphanDependents ,char * propagationPolicy ,v1_delete_options_t * body)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/autoscaling/v2beta2/namespaces/{namespace}/horizontalpodautoscalers/{name}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/autoscaling/v2beta2/namespaces/{namespace}/horizontalpodautoscalers/{name}");
...
AutoscalingV2beta2API_getAutoscalingV2beta2APIResources(apiClient_t *apiClient)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/autoscaling/v2beta2/")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/autoscaling/v2beta2/");
...
AutoscalingV2beta2API_listAutoscalingV2beta2HorizontalPodAutoscalerForAllNamespaces(apiClient_t *apiClient ,int allowWatchBookmarks ,char * continue_ ,char * fieldSelector ,char * labelSelector ,int limit ,char * pretty ,char * resourceVersion ,int timeoutSeconds ,int watch)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/autoscaling/v2beta2/horizontalpodautoscalers")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/autoscaling/v2beta2/horizontalpodautoscalers");
...
AutoscalingV2beta2API_patchAutoscalingV2beta2NamespacedHorizontalPodAutoscalerStatus(apiClient_t *apiClient ,char * name ,char * namespace , body ,char * pretty ,char * dryRun ,char * fieldManager ,int force)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/autoscaling/v2beta2/namespaces/{namespace}/horizontalpodautoscalers/{name}/status")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/autoscaling/v2beta2/namespaces/{namespace}/horizontalpodautoscalers/{name}/status");
