...
#include <stdio.h>
#include <ctype.h>
#include "AuditregistrationV1alpha1API.h"
...
AuditregistrationV1alpha1API_createAuditregistrationV1alpha1AuditSink(apiClient_t *apiClient ,v1alpha1_audit_sink_t * body ,char * pretty ,char * dryRun ,char * fieldManager)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/auditregistration.k8s.io/v1alpha1/auditsinks")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/auditregistration.k8s.io/v1alpha1/auditsinks");
    ...
    {
        //string
        localVarSingleItemJSON_body = v1alpha1_audit_sink_convertToJSON(body);
...
AuditregistrationV1alpha1API_deleteAuditregistrationV1alpha1AuditSink(apiClient_t *apiClient ,char * name ,char * pretty ,char * dryRun ,int gracePeriodSeconds ,int orphanDependents ,char * propagationPolicy ,v1_delete_options_t * body)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/auditregistration.k8s.io/v1alpha1/auditsinks/{name}")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/auditregistration.k8s.io/v1alpha1/auditsinks/{name}");
...
AuditregistrationV1alpha1API_getAuditregistrationV1alpha1APIResources(apiClient_t *apiClient)
{
    ...
    // create the path
    long sizeOfPath = strlen("/apis/auditregistration.k8s.io/v1alpha1/")+1;
    char *localVarPath = malloc(sizeOfPath);
    snprintf(localVarPath, sizeOfPath, "/apis/auditregistration.k8s.io/v1alpha1/");
